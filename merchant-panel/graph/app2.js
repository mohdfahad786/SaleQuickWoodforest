...
function imGraph2(a, b) {
            ...
            shared: !0,
              formatter: function(a) {
                var b = parseInt(this.points[0].y) == this.points[0].y ? this.points[0].y : this.points[0].y.toFixed(2),
                    ...
                    + "</b> <br/>" + '<span style="color: #C14242">' + "Fee  :" + '<b> $' + (c/100*10).toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")
                     + '</b>' + '</span>';
                return d + " <br /> " + e + " <br /> " + f
    ...
    var h = [],
        ...
        j = [];
    for (var k in b)
        if (b[k].convrate = 0 == b[k].people ? 0 : (b[k].conversions / b[k].people * 100).toFixed(2), b[k].cpa = 0 == b[k].conversions ? 
    ...
    c.series[1].name = g, c.series[1].data = i, c.series[1].pointStart = i[0][0].valueOf(), $("#" + a + " .placeholder")
