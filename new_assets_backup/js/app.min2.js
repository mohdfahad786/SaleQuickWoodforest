...
function daterangeInitializerFn(){
    console.log('daterangeInitializerFn')
        var e = {
            ranges: {
    ...
    if ($("#daterange").daterangepicker(e, function(a, b) {
        $("#daterange span").data({'d1':a.format("YYYY-MM-DD") ,'d2' : b.format("YYYY-MM-DD")}),
        $("#daterange span").html(a.format("MMMM D, YYYY") + " - " + b.format("MMMM D, YYYY")),
        "undefined" != typeof getTable && getTable(),
        "undefined" != typeof getGraph && getGraph(),
        ...
        "undefined" != typeof getSaleOrderChartsDate && getSaleOrderChartsDate()
        "undefined" != typeof updateTimeOfDay && updateTimeOfDay()
    ...
    $("#goalfilter").multiselect({
        ...
        a.length > 0 && a.each(function() {
            b.push($(this).val())
        }), b.length > 0 ? userprefs.goal = b.join("^") : userprefs.goal = "all", $(".ovbox .num").html('<i class="fa fa-spinner fa fa-spin"></i>'), "undefined" != typeof getTable && getTable(), "undefined" != typeof saleChartFn && saleChartFn(), "undefined" != typeof getMetrics && getMetrics(), "undefined" != typeof getTabs && getTabs()
...
$(document).ready(function() {
    ...
    // else if ("all" != userprefs.goal)
    //     for (var f = userprefs.goal.split("^"), g = 0; g < f.length; g++) $("#goalfilter").multiselect("select", f[g]);
    $(".glyphicon-search").removeClass("glyphicon glyphicon-search").addClass("fa fa-search"); 
    $(".glyphicon-remove-circle").removeClass("glyphicon glyphicon-remove-circle").addClass("fa fa-remove"); 
    $(".multiselect-container .input-group-addon").hide(); 
    $(".multiselect-container .input-group-btn").hide(); 
