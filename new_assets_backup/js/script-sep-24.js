...
//convert sale summery json to html table
  function saleSummeryPdfTableConvertor($wraper,jd,totals){
    ...
    var newTable=$('<table><thead><th>Amount</th><th>Tax</th><th>Type</th><th>Date</th><th>Referece</th><th>Discount</th><th>Name</th><th>Items</th></thead><tbody></tbody></table>');
    nameCol=true;
    }
    else{
    var newTable=$('<table><thead><th>Amount</th><th>Tax</th><th>Type</th><th>Date</th><th>Referece</th><th>Discount</th><th>Items</th></thead><tbody></tbody></table>');
    ...
    else
    {
      ...
      jsonData.forEach(function(val, i){
        ...
        {
         allRow='<tr><td>'+val.Amount+'</td><td>'+val.Tax+'</td><td>'+val.Type+'</td><td>'+val.Date+'</td><td>'+val.Referece+'</td><td>'+val.Discount+ (nameCol ? '</td><td>'+val.Name : '')+'</td><td>'+val.Items+'</td></tr>';    
        }
