   <div class="topbar">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    <a href="<?php echo base_url(""); ?>" class="logo"> <span style="font-size: 70%;"><?php echo  $session_id = $this->session->userdata('merchant_name'); ?> </span></a>
                </div>
            </div>
 ...
 <?php } ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown " aria-labelledby="Preview">
                            ...
                            <div class="dropdown-item noti-title">
                             ...
                             <!-- item-->
                            <a href="<?php echo base_url('merchant'); ?>" class="dropdown-item notify-item">
                                    <i class=" mdi mdi-view-dashboard"></i> <span>Dashboard</span>
                                </a>
                            <!-- item-->
                            <!-- item-->
                            <a href="<?php echo base_url('merchant/edit_profile'); ?>" class="dropdown-item notify-item">
