		...
		<div class="row sales_date_range">
			<div class="col-12 custom-form">
				<div class="card content-card">
					<!-- <div class="row"> -->
						<form class="row" method="post" action="<?php echo base_url('graph/sale'); ?>" >
							<div class="col-sm-8">
								<div class="row">
									<div class="col-sm-6">
							...
							<div class="col-4 text-right">
								<div class="row">
									...
									<div class="col-4">
										<button class="btn btn-first" type="submit" name="excel_export" value="Excel">Excel</button>
									</div>

									<div class="col-4">
										<button class="btn btn-first" type="submit" name="csv_export" value="CSV">CSV</button>
									</div>
