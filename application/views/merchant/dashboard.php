			...
			<div class="col-3">
				<div class="card-box">
					<div class="request">
						...
						<span class="request-name"> <h4>Completed</h4></span>
						<span class="request-name"> Instore & Mobile Transactions</span>
					</div>
			...
			<div class="col-3">
				<div class="card-box">
					<div class="request">
						...
						<span class="request-name"> <h4>Pending</h4></span>
						<div class="request-name"> Invoice Transactions</div>
					</div>
					<div class="request-icon">
			...
			<div class="col-3">
				<div class="card-box">
					<div class="request">
						...
						<span class="request-name"> <h4>Completed</h4></span>
						<div class="request-name">Invoice Transaction</div>
					</div>
					<div class="request-icon">
			...
			<div class="col-3">
				<div class="card-box">
					<div class="request">
						...
						<span class="request-name"> <h4>Late</h4></span>
						<div class="request-name">Invoice Transactions</div>
					</div>
					<div class="request-icon">
