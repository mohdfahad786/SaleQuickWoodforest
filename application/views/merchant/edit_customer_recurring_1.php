                                                        ...
                                                        <div class="col-12 text-center">
                                                            <div class="checkbox text-center" style="display: inline-block !important;height: 20px !important;">
                                                                <label style="font-size: 16px;font-weight: 600;">
                                                                    <?php 
                                                                    if($get_recurring_invoice->amount>0)
                                                                {?>
                                                                <input type="checkbox" name="carrent_othercharges" id="carrent_othercharges" class="form-check-input" checked >     
                                                                <?php
                                                                } else { ?>
                                                                    <input type="checkbox" name="carrent_othercharges" id="carrent_othercharges" class="form-check-input" >
                                                                    <?php } ?>     

                                                                 <?php if($data[0]['title']!=''){echo $get_recurring_invoice->otherChargesName;  } else { ?>Other Charges <?php } ?> - <?php if($data[0]['percentage']!=''){echo $data[0]['percentage'];} else { ?>0 <?php } ?><?php if($data[0]['type']!=''){echo $data[0]['type'];} else { ?>$<?php } ?>, Total - $    <i class="input-frame"></i> <span id="full_amount_span" ><?php
                                                                if($get_recurring_invoice->amount!='')
                                                                { 
                                                                echo $get_recurring_invoice->amount; ?></span>
                                                                <?php }
                                                                else
                                                                {
                                                                    echo '00.00';
