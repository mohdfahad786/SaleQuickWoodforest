...
<div class="page-content-wrapper">
    <div class="page-content-wrapper-inner">
        ...
        <div class="content-viewport d-none" id="base-contents">
            ...
            <?php $count = 0; ?>
            <form class="row" method="post" action="<?php echo base_url('pos/all_ecommerce_sandbox'); ?>" style="margin-bottom: 20px !important;">
            ...
            <div class="row">
                <div class="col-12">
                    <!--<table id="dt_pos_sale_list" class="table table-hover" style="width:100%">-->
                        <!--<table id="dt_inv_pos_sale_list" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">-->
                                ...
                                <tr>
                                    ...
                                    <!-- <td>
                                        <?php if ($a_data['status'] == 'confirm' || $a_data['status'] == 'Chargeback_Confirm') { ?>
                                            <a class="badge-btn resend_rcpt_btn" data-id="<?php echo $a_data['id']; ?>" title="Re-send Receipt" href="#">Re-send</a>
                                        <?php } ?>
                                    </td> -->
