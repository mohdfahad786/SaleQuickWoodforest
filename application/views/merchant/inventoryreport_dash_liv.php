            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    <!-- <form method="post" action="<?php echo base_url('inventory_report/inventoryreport'); ?>" > -->
                        ...
                        <span class="pdf_span">
                            <!-- <a download="Inventory Report.pdf" class="btn btn-rounded social-btn-outlined btn_width_sm" id="btn_pdf" style="margin-right: 5px;"><i class="mdi mdi-arrow-down small"></i>PDF</a> -->
                            ...
                            <!-- <button id="hidden_pdf_btn"></button> -->
