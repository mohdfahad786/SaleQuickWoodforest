                  ...
                  <tbody>
                    <?php
                      ...
                      <tr>
                          ...
                          <td style="Font-size:15px;"><?php echo Ucfirst($a_data['mname']) ?></td>
				...
				{ ?> 
                          ...
                          <td>
                              <span class="card-type-image">
                                <?php  if($parent_Data['item_image']!='') {
                                ?>
                                <img src="<?=base_url()?>uploads/item_image/<?php echo $parent_Data['item_image']; ?>"  >
                                <?php }else{ ?>
                        ...
                        <td>-<?php if(Ucfirst($parent_Data['title'])!='Regular'){echo Ucfirst($parent_Data['title']);} elseif(Ucfirst($parent_Data['title'])=='Regular'){echo Ucfirst($parent_Data['name']);}  ?></td>
                          ...
                          <!-- <td><?php echo date("M d Y h:i A", strtotime($parent_Data['date'])); ?></td> -->
