                                            ...
                                            if($a_data['status']=='confirm' || $status=='confirm') { 
                                                ...
                                                <div class="dropdown dt-vw-del-dpdwn">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item pos_vw_refund" data-id="<?php echo $a_data['id']; ?>" href="<?php echo base_url('SendRecurring/rerunCard/'.$a_data['invoice_no']); ?>"><span class="fa fa-credit-card"></span>  Re-run card</a>
                                                        ...
                                                        <a class="dropdown-item pos_vw_refund" href="#AddCard" data-toggle="modal" data-target="#AddCard"><span class="fa fa-credit-card"></span> Update card by merchant</a>
                                                    </div>
                                                </div> 
...
<div class="modal fade" id="AddCard" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Update Your Card Details</h5>
            ...
            <div class="modal-body">
                ...
                <div class="invoice-wrapper">
                   <div class="irm-header-inner">
                        ...
                        <form class="cardPaymentFormWrapper row" action="<?= base_url('AcceptCard/updateCardByMerchant/'.$a_data['invoice_no']) ?>" method="post">
                            <!-- <div class="col-xs-6"> -->
