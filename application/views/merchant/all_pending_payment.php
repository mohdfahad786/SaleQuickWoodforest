...
<div class="col-md-12">
  ...
  <div class="card-box">
    <form method="post" action="<?php echo base_url('pos/all_pending_payment');?>" >
                        <div class="row">
...
<?php } else if($a_data['type']=='recurring') { ?>
         ...
         <?php if($a_data['type']=='straight') { ?>
          ...
          <?php if($a_data['payment_type']=='straight') { ?>

              <a href="#" > <button class="btn btn-sm btn-warning"> No</button> </a>
<?php } else if($a_data['payment_type']=='recurring') { ?>
...
{ ?>
 ...
 <a class="btn btn-sm  btn-danger"  onClick="alert('Your All Dues are Clear and Payment complete!')"> <i class=" mdi mdi-thumb-up"></i> Done</a>
