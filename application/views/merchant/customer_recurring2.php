                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 0px 30px 0px 30px !important;">
                                        <div class="row" style="height: 55px !important;">
                                            <div class="col-6" style="border: 1px solid rgb(212, 240, 255) !important;">
                                                <input class="form-control" name="name" id="s_name" pattern="[a-zA-Z\s]+" placeholder="Name" value="<?php echo (isset($name) && !empty($name)) ? $name : set_value('name');?>" required type="text" autocomplete="off" style="border: none !important;margin-top: 5px !important;">
                                            </div>
                                            <div class="col-6" style="border: 1px solid rgb(212, 240, 255) !important;">
                                                <input class="form-control" name="s_email" id="s_email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,5}$" placeholder="Email" value="<?php echo (isset($email) && !empty($email)) ? $email : set_value('email');?>"  type="text" style="border: none !important;margin-top: 5px !important;">
                                            </div>
                                        </div>
                                        <style>
                                        ...
                                        <div class="row" style="height: 55px !important;">
                                            ...
                                            <div class="col-6" style="border: 1px solid rgb(212, 240, 255) !important;">
                                                <input type="text" name="s_start_date" class="form-control" id="s_invoiceDueDatePicker" placeholder="Start Date" name="" autocomplete="off" required style="border: none !important;margin-top: 5px !important;" required>
                                            </div>
                                        </div>
                                        <!-- added -->
                                        <div class="row" style="height: 75px border: 1px solid rgb(212, 240, 255) !important;">
                                            <input type="text"  class="form-control text-center" name="recurring_type" value="Interval" onclick="javascript:void(0)" id="recurring_type" readonly required>
                                      ...
                                      <!--   <select  class="form-control" id="recurring_type" name="recurring_type" required>
                                        ...
                                        <div class="row" style="height: 95px; border:1px solid rgb(212, 240, 255) !important;">
                                                ...
                                                <input type='text' style="width: 80px;display: inline-block;vertical-align: middle;margin-left: 15px;" class='form-control text-center' name='recurring_count' id='recurring_count' maxlength="3" placeholder="Count" onKeyPress="return isNumberKey(event)">
                                             </div>
                                        </div>
                                        ...
                                        <div class="row" style="border:1px solid rgb(212, 240, 255) !important;">
                                            <div class="text-center col-12">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col-12 text-center">
                                                        <input type="radio" id="pt__Auto" value="1" name="paytype">    Auto 
                   ...
                   <div class="irm-header-inner">
                        <form id="pop_inputs" class="cardPaymentFormWrapper row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6 card-form">
                                ...
                                <button type="button" class="btn btn-first d-colors" style="border-radius: 20px;"> Complete The Payment</button>
                            </div>
                            <style>
