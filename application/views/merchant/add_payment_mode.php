          ...
          <div class="card content-card">
            <div class="card-title">
                <?php
                    if(isset($msg))
                    echo "<h4> $msg</h4>";
                    echo form_open('merchant/'.$loc, array('id' => "my_form",'class' => "row  responsive-cols custom-form"));
                    ...
                    <div class="col mx-253">
                      <div class="custom-form">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="title" id="title"  placeholder="Name"  required value="<?php echo (isset($title) && !empty($title)) ? $title : set_value('title');?>">
                        </div>
                      </div>      
                    </div>
