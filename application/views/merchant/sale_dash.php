        ...
        if (data.length == 0) {
            ...
            $.each(data, function( key, value ) {
                if (key != 'empTip') {
                    ...
                    if(label == 'Total') {
                        people = value['SaleAmount'];
                        clicks = value['RefundAmount'];
                        converted_people = value['NetAmount'];
                    }
                    // console.log(sum_final_sale,sum_final_refund,sum_final_net);
                }
            });
            // console.log(data);
