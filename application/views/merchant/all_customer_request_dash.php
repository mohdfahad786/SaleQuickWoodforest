                  ...
                  <!--<table id="dt_inv_pos_sale_list" class="table  dt-responsive nowrap" style="width:100%">-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="card-type-no-wraper">
                                        <span class="card-type-image">
                                            <?php
                                                $typeOfCard = str_replace(' ','',strtolower($a_data['card_type']));
                                                switch ($typeOfCard) {
                                                    case 'discover':
                                                    ...
                                                    case 'american express':
                                                        ...
                                                        break;
                                                    default:
                                                        $card_image = (empty($typeOfCard) && empty($a_data['card_no']))? 'nocard.png': 'other.png';
                                                }
                                            ?>
                                            <img src="<?=base_url()?>new_assets/img/<?php echo $card_image; ?>" alt="<?php echo $a_data['card_type'] ?>" style="height: 25px !important;max-width: 40px !important;margin-right: 10px !important;border-radius: 5px !important;">
                                        </span>
                                ...
                                <?php } ?>
                                <td>
                                    <?php echo (isset($a_data['repeiptmethod']) && !empty($a_data['repeiptmethod'])) ? htmlentities($a_data['repeiptmethod']) : 'No Receipt'; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php echo ( $a_data['status'] != 'Refund') ? date("M d, Y", strtotime($a_data['due_date'])) : '--'; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php if ($a_data['status'] == 'pending') { ?>
                                        <span>
                                            <button type="submit" id="re_invoice_by_list" data-id="<?php echo $a_data['id'];?>" name="submit" class="resend_rcpt_btn2">Re-Send</button>
                                        </span>
                                    <?php } ?>
                                </td>
                                <td>
                                    <?php if ($a_data['status'] == 'Refund') { ?>
                                        <a class="pos_Status_c badge-btn invoice_pos_list_item_vw__refund_recept" data-id="<?php echo $a_data['id'];  ?>" data-row-id="<?php echo $a_data['refund_row_id'];  ?>"  href="#"><span class="fa fa-eye"></span> Receipt</a>
                                    ...
                                    <?php } elseif($a_data['status'] == 'pending') { ?>
                                        <div class="dropdown dt-vw-del-dpdwn">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item invoice_pos_list_item_vw_recept" data-id="<?php echo $a_data['id'];  ?>" href="#"><span class="fa fa-eye"></span>  View</a>
                                                <a class="dropdown-item invoice_pos_list_item_vw_refund" onClick="pending_delete(<?php echo $a_data['id'];?>)" href="#"><span class="fa fa-trash"></span>  Delete</a>
                                                <?php if($a_data['attachment']!="") { ?>
                                                    <a   href="<?php echo base_url().'uploads/attachment/'.$a_data['attachment'];?>" target="_blank"  class="dropdown-item invoice_pos_list_item_vw_refund"  data-id="<?php echo $a_data['id'];  ?>" download><span class="fa fa-download"></span> Download Attachment  </a>
                                                             <?php }  ?> 
                                            </div>
                                        </div>
                                    <?php } else {
                                        if ($a_data['status'] == 'confirm' || $a_data['status'] == 'Chargeback_Confirm') { ?>
                                            <a href="#" class="invoice_pos_list_item_vw_paid_recept pos_Status_c badge-btn" data-id="<?php echo $a_data['id'];  ?>"><span class="fa fa-eye"></span> Receipt</a>
                                        <?php } else {?>
                                            <a href="#" class="invoice_pos_list_item_vw_recept pos_Status_c badge-btn" data-id="<?php echo $a_data['id'];  ?>"><span class="fa fa-eye"></span> Receipt</a>
                                        <?php } ?>
                                        <?php if($a_data['attachment']!="") { ?>
                                            <a href="<?php echo base_url().'uploads/attachment/'.$a_data['attachment'];?>" target="_blank" class=" pos_Status_c badge-btn" data-id="<?php echo $a_data['id'];  ?>" download><span class="fa fa-download"></span> Download Attachment</a>
                                        <?php }
                                    } ?> 
                                </td>
                            </tr>
        ...
        <div class="modal-content" id="invoicePdfData">      
            <div class="modal-header"> 
                ...
                <div class="irm-header-inner">
                    <div class="row">
                        <div class="col">
                            <div class="irm-logo">
                                <img src="https://salequick.com/logo/image_201908200049.png" alt="logo">
                            </div>
                            <div class="irm-def">
                                <h4>Test</h4>
                                <p><b>Telephone: </b> -</p>
            ...
            <div class="modal-footer"> 
                ...
                <div class="col text-right">
                    ...
                    <form class="form-control-static text-right float-right" action="https://salequick.com/pos/refund_pos" abc="CNP" method="post">
