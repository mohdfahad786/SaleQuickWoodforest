                                    ...
                                    <div class="row" style="margin-top: 15px;">
                                        <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 0px 30px 0px 30px !important;">
                                            ...
                                            <script>
                                                ...
                                                <div class="row" style="height: 55px !important;">
                                                <div class="col-6" style="border: 1px solid rgb(212, 240, 255) !important;">
                                                    <input class="form-control" placeholder="Mobile Number" name="s_mobile" id="s_phone" value="<?=$get_recurring_invoice->mobile_no; ?>" type="text" style="border: none !important;margin-top: 5px !important;" required>
                                                </div>
                                                <div class="col-6" style="border: 1px solid rgb(212, 240, 255) !important;">
                                                    <?php if($get_recurring_invoice->recurring_count_paid != 0){ ?>
                                            ...
                                            <div class="row" style="height: 95px; border:1px solid rgb(212, 240, 255) !important;">
                                                ...
                                                <div class="col-12 text-center">
                                                    ...
                                                    <?php if($get_recurring_invoice->recurring_count < 0 ){ ?>
                                                        <input type='text' style="width: 80px;display: inline-block;vertical-align: middle;margin-left: 15px;" class='form-control' value="" name='recurring_count' id='recurring_count' maxlength="3" placeholder="Count" onKeyPress="return isNumberKey(event)">    
                                                    <?php } else { ?> 
                                                        <input type='text' style="width: 80px;display: inline-block;vertical-align: middle;margin-left: 15px;" class='form-control' value="<?php if($get_recurring_invoice->recurring_count_remain > 0 ) echo $get_recurring_invoice->recurring_count_remain; ?>" name='recurring_count' id='recurring_count' maxlength="3" placeholder="Count" onKeyPress="return isNumberKey(event)">
                                                    <?php } ?>
                                                 </div>
                                            </div>
                                            ...
                                            <div class="row" style="border:1px solid rgb(212, 240, 255) !important;">
                                                <div class="text-center col-12">
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-12 text-center">
                                                            <input type="radio" id="pt__Auto"  value="1" name="paytype" <?php echo (($get_recurring_invoice->recurring_pay_type=='1')? 'checked' : ''); ?> checked>    Auto 
                                                            <input style="margin-left:50px;" type="radio" id="pt__Manual" <?php echo (($get_recurring_invoice->recurring_pay_type=='1')? '' : 'checked'); ?> value="0" name="paytype">    Manual
                                                        </div>
                                                    </div>

                                                    <div class="row mb-4">
                                                        <div class="col-sm-6 col-md-5 col-lg-5">
                                                            <!-- <a href="#AddCard" data-toggle="modal" data-target="#AddCard">Add Card?</a> -->
                                                            <a href="javascript:void(0)" id="show_card_popup">Add Card?</a>
                                                        </div>
                                                        <?php if($token!=null) { ?>
...
<div class="modal fade" id="AddCard" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Your Card Details</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <!-- <?php echo base_url().'AcceptCard/';?> -->
                ...
                <div class="invoice-wrapper">
                   <div class="irm-header-inner">
                        <form class="cardPaymentFormWrapper row" action="<?= base_url('AcceptCard/saveCard') ?>" method="post">
                            <!-- <div class="col-xs-6"> -->
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <!-- <div class="row" style="margin-left: 0px !important;">
                                    <h3 class="back-btn-title">
                                        <a href="<?= base_url('merchant/add_customer_request')?>" onclick="goBack()" class="BacktoInvoice">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6 card-form">
                                <div class="pay-detail" style="display: inline-block;width: 100%;">
                                    ...
                                    <div class="mycl-wrapper responsive-cols flex-row" style="margin: 0 -15px !important;">
                                        <div class="flex-col">
                                            <div class="form-group fg-half">
                                                <?php
                                                $currYr=date('Y');
                                ...
                                <button type="submit" class="btn btn-first d-colors" style="border-radius: 20px;"> Complete The Payment</button>
                            </div>
                            <style>
