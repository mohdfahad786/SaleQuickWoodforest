...
$getMarchentlogo = $this->db->query("SELECT ecom_transaction_mode,payroc from merchant where id = '".$merchant_id."' ");
...
<div class="sidebar" style="overflow: auto !important;">
        ...
        <div class="display-avatar sidebar_logo_preview">
            ...
            <?php } else { ?>
                <div class="img-lg-custom-text-light">
                    <?php echo substr($this->session->userdata('business_dba_name'),0,1); ?>
                </div>
    ...
    <ul class="navigation-menu">
        <?php if($this->session->userdata('merchant_status')!='active') { ?>
            <li style="background-color: rgba(0, 166, 255, 0.2) !important;">
                <a class="<?php echo ($this->session->userdata('merchant_status')=='Waiting_For_Approval')?'blink':''?>" href="<?php echo base_url('merchant/after_signup'); ?>">
                    <span style="color: #216078 !important;font-size: 16px !important;">
        ...
        <?php if( $this->session->userdata('merchant_user_type')=='employee' && ( in_array("3c", $menuarraydata)  )  ) { ?>
            <li>
                ...
                <a href="<?php echo base_url('customer_recurring'); ?>">
        ...
        <?php if($this->session->userdata('merchant_user_type')=='merchant') { ?>
            ...
            <!-- <?php if($this->session->userdata('merchant_id') == '413') { ?>
                <li>
                    <a href="<?php echo base_url('customer_recurring'); ?>">
                        <span class="link-title">New Recurring</span>
                        <img class="img-ss mb-1 mr-2" src="<?php echo base_url('new_assets/img/new-icons/recurring-icon.png'); ?>" alt="sidebar-icon">
                    </a>
                </li>
            <?php } ?> -->
        ...
        <li>
            ...
            <ul class="collapse navigation-submenu" id="transactions">
                <?php if($this->session->userdata('merchant_user_type')=='employee') { ?>
                    <?php if(in_array("2a", $menuarraydata)) { ?>
                        <li>
                            <a href="<?php echo base_url('pos/all_pos'); ?>">Instore & Mobile</a>
                        </li>
                    <?php } ?>

                    <?php if(in_array("2b", $menuarraydata)) { ?>
                        <li>
                            <a href="<?php echo base_url('pos/all_customer_request'); ?>">Invoicing</a>
                        </li>
                    <?php } ?>

                    <?php if(in_array("2c", $menuarraydata)) { ?>
                        <li>
                ...
                <?php } if($this->session->userdata('merchant_user_type')=='merchant') { ?>
                    ...
                    <?php if($ecom_transaction_mode=='live') { ?>
                        <li>
                            <a href="<?php echo base_url('pos/all_ecommerce'); ?>">Ecommerce</a>
                        </li>
                    <?php } else if($ecom_transaction_mode=='sandbox') { ?>
                        <li>
                            <a href="<?php echo base_url('pos/all_ecommerce_sandbox'); ?>">Ecommerce Sandbox</a>
                        </li>
                    <?php } ?>
                <?php } ?>
            ...
            <li>
                ...
                <ul class="collapse navigation-submenu" id="inventory">
                    <?php if( $this->session->userdata('merchant_user_type')=='employee' && ( in_array("4c", $menuarraydata)  )  ) { ?>
                        <li>
                            <a href="<?php echo base_url('inventory/inventorymngt'); ?>">Inventory Management</a>
                        </li>
                    <?php } if( $this->session->userdata('merchant_user_type')=='employee' && ( in_array("4d", $menuarraydata)  )  ) { ?>
                        <li>
                            <a href="<?php echo base_url('inventory/inventoryreport'); ?>">Reports</a>
                        </li>
                    <?php } ?>
                </ul>
            </li>
        ...
        <?php if($this->session->userdata('merchant_user_type')=='merchant') { ?>
            <li>
                ...
                <ul class="collapse navigation-submenu" id="inventory">
                    ...
                    <li>
                        <a href="<?php echo base_url('inventory_report'); ?>">Reports</a>
                    </li>
                </ul>
            </li>
        <?php } ?>
        ...
        <li>
            ...
            <ul class="collapse navigation-submenu" id="profile_settings">
                ...
                <?php if($this->session->userdata('merchant_user_type')=='merchant') { ?>
                    <!-- <li>
                        <a href="<?php echo base_url('merchant/other_settings'); ?>">Other Settings</a>
                    </li> -->
                    <li>
                    ...
                    <?php if($payroc==1) { ?>
                        <li>
                            <a href="<?php echo base_url('merchant/link_pay'); ?>">Link Pay</a>
                        </li>
                    <?php } ?>
                    ...
                    <li>
                        <a href="<?php echo base_url('merchant/tip_setting'); ?>">Tip</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo base_url('merchant/notification_setting'); ?>">Notification</a>
                    </li>

                    <?php if($this->session->userdata('merchant_id') == '413') { ?>
                        <li>
                            <a href="<?php echo base_url('token/token_list'); ?>">Token</a>
                        </li>
                    <?php } ?>
