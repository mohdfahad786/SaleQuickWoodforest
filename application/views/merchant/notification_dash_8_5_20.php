                ...
                <div class="col-8" style="margin: auto;">
                    <div class="grid grid-chart">
                        <div class="grid-body d-flex flex-column">
                            <div class="mt-auto" style="padding: 15px 25px !important;">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <p>Payment Status: <span class="<?php if($gettransaction['transaction_id']!="") { echo 'pos_Status_c'; }else{ echo 'pos_Status_cncl'; }?>"><?php if($gettransaction['transaction_id']!="") { echo 'Paid'; }else{ echo 'Unpaid'; } ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
