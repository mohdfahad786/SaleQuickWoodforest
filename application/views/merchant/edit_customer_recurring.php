                                ...
                                <div class="mt-auto">
                                    <div class="row" style="margin-top: 15px;">
                                        <div class="col-sm-12 col-md-12 col-lg-12" style="padding: 0px 30px 0px 30px !important;">
                                            ...
                                            <?php //echo '<pre>';print_r($get_recurring_invoice);echo '</pre>'; ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 text-center">
                                                            <div class="" style="border: none !important;margin: auto !important;display: inline-flex;">
                                                                ...
                                                                <?php $new_amount = ($get_recurring_invoice->update_amount!='0.00') ? $get_recurring_invoice->update_amount : $get_recurring_invoice->sub_total; ?>

                                                                <?php if($get_recurring_invoice->recurring_count_paid != 0){ ?> 
                                                                    <input type="text" name="s_amount"  onkeyup="this.style.width = ((this.value.length + 30) * 8) + 'px';"   autocomplete="off" maxlength="10" onkeypress="return isNumberKey(event)" class="form-control text-right" id="money" value="<?php echo $get_recurring_invoice->sub_total; ?>" placeholder="0.00" style="background-color: #fff !important;border: none !important;text-align: center !important;height: 80px !important;font-family: AvenirNext-Medium !important;color:#000 !important;z-index: 0 !important;width:200px;"  >
                                                                 <?php } else { ?>
                                                                 <input type="text" name="s_amount" value="<?php echo $get_recurring_invoice->sub_total; ?>"onkeyup="this.style.width = ((this.value.length + 30) * 8) + 'px';"  required autocomplete="off" maxlength="10" onkeypress="return isNumberKey(event)" class="form-control text-right"  id="money" placeholder="0.00" style="background-color: #fff !important;border: none !important;text-align: center !important;height: 80px !important;font-family: AvenirNext-Medium !important;color:#000 !important;z-index: 0 !important;width:200px;">  <?php } ?> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php
                                                    ...
                                                    <div class="row" style="margin-top: 10px;">
                                                        <div class="col-12 text-center">
                                                            <div class="checkbox text-center" style="display: inline-block !important;height: 20px !important;">
                                                                ...
                                                                <?php if($get_recurring_invoice->other_charges > 0){echo $get_recurring_invoice->otherChargesName; } else { ?>Other Charges <?php } ?> - <?php if($get_recurring_invoice->other_charges > 0){echo $data[0]['percentage'];} else { ?>0 <?php } ?><?php if($data[0]['type']!=''){echo $data[0]['type'];} else { ?>$<?php } ?>, Total - $    <i class="input-frame"></i> <span id="full_amount_span"><?php echo ($get_recurring_invoice->other_charges > 0) ? $new_amount : '0.00'; ?></span>
                                            ...
                                            <div class="row" style="height: 75px border: 1px solid rgb(212, 240, 255) !important;">
                                                <input type="text"  class="btn btn-first" name="recurring_type" value="<?php if($get_recurring_invoice->recurring_type_week!='')
                                                {
                                                ...
                                                ?>" onclick="javascript:void(0)" id="recurring_type" readonly required style="width: 100%;margin: 0px 15px 15px;">
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12 card-form">
                                        ...
                                        <button type="button" class="btn btn-first d-colors" style="border-radius: 8px !important;margin: 15px 0px !important;width: 100%;">Complete Payment</button>
                                    </div>
                                    <style>
            ...
            $.ajax({
                ...
                success: function(data1) {
                    if(data1.code=='200') {
                        ...
                        $('.d-colors').html('Complete Payment');
