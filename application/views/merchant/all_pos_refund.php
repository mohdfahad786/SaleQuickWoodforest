			...
			<div class="row">
				<div class="col-12">
					<div class="back-title m-title"> 
						<span>Point Of Sale Refund List</span>
					</div>
				</div>
			</div>
			<div class="row sales_date_range">
				...
				<div class="col-12 custom-form">
					<div class="card content-card">
						<form class="row filter-typesec" method="post" action="<?php echo base_url('refund/all_pos');?>">
							<div class="col mx-350">
								<div id="all_pos_refund_daterange" class="form-control date-range-style">
					...
					<div class="card content-card">
						<div class="card-detail">
							...
							<div class="reset-dataTable">
								<table id="all_pos_refund_dt" class="display salequick-dt" style="width:100%">
									<thead>
											<tr>
													<th>Invoice</th>
													<th>Name</th>
