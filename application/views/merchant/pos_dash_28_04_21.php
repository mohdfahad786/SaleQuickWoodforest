                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" style="border: none !important;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" autocomplete="off" onKeyPress="return isNumberKey(event)" minlength="14" name="card_no" id="card_no" placeholder="Card Number" required style="border-right: none !important;border-top-right-radius: 0px !important;border-bottom-right-radius: 0px !important;">
...
<script>
    ...
    // $(document).on('click', '#paymentCheckoutSubmitBtn', function() {
    //     var phone = $('#phone').val();
    ...
    //         // $('input.form-control#phone').css('border', '1px solid red');
    ...
    $(document).on('click', '#paymentCheckoutSubmitBtn', function() {
        ...
        if(pay_amount == 0) {
            alert('Payable Amount must me greater than Zero');
            return false;
        }
		...
		if (count > 0) {
		    ...
		    $('#paymentCheckoutSubmitBtn').html('<i class="fa fa-spin fa-spinner"></i> Processing...');
		}
    })
