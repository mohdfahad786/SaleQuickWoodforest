        ...
        <div class="content-viewport d-none" id="base-contents">
            ...
            ?>
                <div class="row" style="margin-bottom: 10px !important;">
                    ...
                    <?php if($this->session->userdata('merchant_user_type')=='merchant') { ?>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="grid grid-chart" style="width: 100% !important;height: 273px;">
                            <div class="grid-body d-flex flex-column">
                                <div class="mt-auto">
                        ...
                        <div class="grid grid-chart" style="width: 100% !important;height: 227px !important;">
                            <div class="grid-body d-flex flex-column">
                                <div class="mt-auto">
                                    <div class="row" style="margin-top: 10px !important;">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <?php //echo '<pre>';print_r($this->session->userdata('merchant_id'));echo '</pre>'; ?>
                                ...
                                <div class="mt-auto">
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label for="">Ecom Transaction Mode</label>
                                                <select class="form-control" name="ecom_transaction_mode" id="ecom_transaction_mode">
                                                    <option value="">Select Transaction Mode</option>
                                                    <option value="live" <?php if($ecom_transaction_mode=='live'){ echo 'selected'; } ?> >Live</option>
                                                    <option value="sandbox" <?php if($ecom_transaction_mode=='sandbox'){ echo 'selected'; } ?> >Sandbox</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row <?php echo ($this->session->userdata('merchant_id') == '413') ? '' : 'd-none'; ?>" style="margin-bottom: 10px !important;">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="grid grid-chart" style="width: 100% !important;">
                            <div class="grid-body d-flex flex-column">
                                <div class="mt-auto">
                                    <div class="form-title">Other Charges and Tax options</div>
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <input type="radio" id="tax_over_oc" name="tax_option" value="0" <?php if($tax_option == 0){ echo 'checked'; } ?> style="display: inline !important;">
                                            <label for="oc_over_tax" style="display: inline !important;">Other Charges over Tax</label><br>
                                            
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <input type="radio" id="oc_over_tax" name="tax_option" value="1" <?php if($tax_option == 1){ echo 'checked'; } ?> style="display: inline !important;">
                                            <label for="tax_over_oc" style="display: inline !important;">Tax over Other Charges</label><br>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <input type="radio" id="normal" name="tax_option" value="2" <?php if($tax_option == 2){ echo 'checked'; } ?> style="display: inline !important;">
                                            <label for="normal" style="display: inline !important;">Same Time</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="grid grid-chart" style="width: 100% !important;">
                            <div class="grid-body d-flex flex-column">
                                <div class="mt-auto">
                                    <div class="form-title" style="margin-bottom: 15px !important;">Employee PIN Access</div>
                                    <div class="row">
                                        <div class="col-12">
                                            <span class="start_stop_show_inv active" rel="238">
                                                <label class="switch switch_type1" role="switch" style="z-index: 0 !important;margin-bottom: 0 !important;">
                                                    <input type="checkbox" name="emp_access" class="switch__toggle" <?php if($emp_access == 1) { echo 'checked'; } ?> id="switchval" value="1">
