      ...
      <div class="login-box-body">
       ...
       <form>
        ...
        <div class="col-xs-12"> 
              ...
              <div class="col-xs-4" style="margin:12px;">   
                  <button type="submit" id="btn_login" name="btn_login" value="Login" class="btn btn-primary btn-block btn-flat">Sign In</button>    
                  </div>
           ...
           <div class="checkbox icheck">
              <!--  <label>
                  ...
                  <a href="<?php echo base_url('reset'); ?>">I forgot my password</a><br>
