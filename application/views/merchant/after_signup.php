        ...
        <div class="col-12">
          <div class="card content-card">
            ...
            <div class="card-detail required__message">
              <div class="row">
                <div class="col-12 ">
                  <div class="card-detail  aftersignup_tabswrapper "> <!--aftersignup_tabswrapper-->
                    ...
                    <form class="form-group" id="activateAccountform">
                      <div class="col-12">
                        <ul class="nav nav-tabs" id="activateacc__tabs" role="tablist">
                          ...
                          <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#as__bownerinfo" role="tab" data-val="2" aria-controls="as__bownerinfo"><span class="badge">2.</span> <span>Business Owner Information</span></a>
                          </li>
                          <li class="nav-item ">
                        ...
                        <div class="tab-content dobWrapper__activateAcc">
                          <div class="tab-pane active" id="as_yourb" role="tabpanel" data-step="1">
                            <div  class="card_info_inner">
                              <div class="row astab__form">
                                ...
                                <!-- <div class="col-12">
                                  <div class="form-group">                
                                    <input type="text" class="form-control any-char required"  placeholder="Legal Business Name">
                                  </div>
                                </div>
                                <div class="col-12">
                                  <div class="form-group">                
                                ...
                                <div class="col-12">
                                  <div class="form-group">                
                                    <input type="text" class="form-control any-no required"  placeholder="EIN (Employer Identification Number) ">
                                  </div>
                                </div>
                                <div class="col-12">
                                  <div class="form-group">                
                                    <input type="text" class="form-control any-char addressFields" id="bsiness_address" placeholder="Business Address">
                                  </div>
                                </div> -->
                                <div class="col-12">
                          ...
                          <div class="tab-pane " id="as__bownerinfo" role="tabpanel" data-step="2">
                           ...
                           <!-- <div class="row astab__form">
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control any-char required"  placeholder="Full Name"   >
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group row dobWrapper__activateAcc">                
                                <div class="col-12"><span>DOB</span></div>
                                <div class="col-4">
                                  <select class="form-control required" id="as__month" required>
                                    <option value="">Month</option>
                                ...
                                <div class="col-4" >
                                  <select class="form-control required" id="as__day" required>
                                    <option value="">Day</option>
                                    <?php
                                    for ($i=1; $i <= 31; $i++) { 
                                    ?>
                                ...
                                <div class="col-4">
                                  <select class="form-control required"  id="as__year" required>
                                    <option value="">Year</option>
                                    <?php
                                      $currYear=date('Y');
                                      for ($currYear; $currYear >= 1900 ; $currYear--) 
                                      { 
                                    ?>
                              ...
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control"  placeholder="Ownership Percentage"   >
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" id="social_scurity_no" value=""  class="form-control any-no encrypted-field ssnL__eight required" name="mssno"  placeholder="Social Security Number">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text"  value="" class="form-control any-no encrypted-field no-dash required" name="mdlno"  placeholder="Drivers License Number">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control addressFields" id="home_address" placeholder="Home Address">
                                </div>
                              </div> -->
                              <div class="col-12">
                                <div class="form-group text-right"> 
                                  <!-- <button type="button" class="btn btn-second initail stepper-back"> Back</button> -->
                                  <button type="button" class="btn btn-first initail stepper-next"> Next</button>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="tab-pane " id="as__backDet" role="tabpanel" data-step="3">
                            <div class="row astab__form">
                              ...
                              <!-- <div class="col-12">
                                <div class="form-group">  
                                  <input type="text" class="form-control us-routing-c" maxlength="9" name="confrouteNo" value="<?php echo $mearchent['bank_routing']; ?>"  placeholder="Confirm Routing Number" required autocomplete="off" onkeypress="return isNumberKey(event)">
                                </div>
                              </div> -->
                              <div class="col-12">
                              ...
                              <!-- <div class="col-12">
                                <div class="form-group">  
                                  <input type="text" class="form-control us-acc-no-c" maxlength="17" name="confaccno" value="<?php echo $mearchent['bank_account']; ?>"  placeholder="Confirm Account Number" required autocomplete="off" onkeypress="return isNumberKey(event)">
                                </div>
                              </div> -->
                              <!-- <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control any-no required"  placeholder="Routing Number"   >
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control any-no required acc1"  placeholder="Account Number">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control any-no required acc2"  placeholder="Confirm Account Number">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="form-group">                
                                  <input type="text" class="form-control any-char required"  placeholder="Bank Name"   >
                                </div>
                              </div> -->
                              <div class="col-12">
                                <div class="form-group text-right"> 
             ...
             $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(data=='200')
                    {
                      ...
                      $('.alert_message').html('<span class="text-success">Account updated..</span>'); 
                      $('.aftersignup_tabswrapper .nav.nav-tabs .nav-link[data-val="'+(nextStp -1)+'"] span:first-child').removeClass('badge').text('').addClass('fa fa-check').parent().addClass('status_success');
                    }
                    else
                    {
                      $('.alert_message').html('<span class="text-danger">'+data+'</span>');
                    }
                }
