...
<html lang="en">
    <head>
        ...
        <title><?php if(isset($title)) { echo $title; }else{ echo ' Merchant | Dashboard'; }?></title>
        ...
        <!-- <link href="<?php echo base_url('new_assets/style-old.css'); ?>" rel="stylesheet" type="text/css"> -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('new_assets/css/datatables.min.css'); ?>"/>
        <!-- <link href="https://salequick.com/merchant-panel/assets/css/dcalendar.picker.css" rel="stylesheet" type="text/css"> -->
