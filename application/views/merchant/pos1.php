...
<body class="fixed-left">
    ...
    echo "<h4> $msg</h4>";
     ...
     echo form_open('pos/'.$loc, array('id' => "my_form"));
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                              <input type="text" class="form-control" name="amount" id="amount"  onKeyPress="return isNumberKeydc(event)" placeholder="Amount"  autocomplete="off"
