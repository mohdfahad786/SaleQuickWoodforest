                        ...
                        <tbody>
                            ...
                            foreach ($package_data_no_main_item as $a_data) { ?>
                                <tr>
                                    <td>
                                        <span class="card-type-image">
                                            <?php if($a_data['item_image']!='') { ?>
                                                <img src="<?=base_url()?>uploads/item_image/<?php echo $a_data['item_image']; ?>" style="width:40px !important;height:40px !important;border-radius: 10px !important;">
                                            <?php } else { ?>
                                                <!-- <div class="text-danger" style="width:40px !important;height:40px !important;">No-Image</div> -->
                                    ...
                                    <?php if($merchant_id == '413') { ?>
                                    <td>
                                        <a href="<?php echo base_url('Inventory/editInventory/'); ?><?php echo $a_data['id']; ?>"><i class="fa fa-pencil"></i></a>
                                        <a href="#" onClick="del_main_item(<?php echo $a_data['item_id'];?>)"><i class="fa fa-trash"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
                            ...
                            foreach ($mem as $a_data) { ?>
                                ...
                                foreach ($parent as $parent_Data) { ?> 
                                    <tr style="height: 40px !important;">
                                        ...
                                        <?php if($merchant_id == '413') { ?>
                                        <td>
                                            <a href="<?php echo base_url('Inventory/editInventory/'); ?><?php echo $parent_Data['id']; ?>"><i class="fa fa-pencil"></i></a>
                                            ...
                                            <a href="#" onClick="del_tier_item(<?php echo $parent_Data['id'];?>)"><i class="fa fa-trash"></i></a>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                <?php }
