      ...
      <div class="row">
        <div class="col-12">
          <div class="back-title m-title">
            ...
            <a class="btn btn-custom1" href="<?php echo base_url('merchant/add_user'); ?>"><span>Add Employee</span> <span class="material-icons">add</span></a>
          </div>
        </div>
      </div>
      <div class="row">
          ...
          <div class="card content-card">
            <div class="card-detail">
              ...
              <div class="reset-dataTable">
                <table id="dt_all_users_list" class="display salequick-dt" style="width:100%">
                  <thead>
                      <tr>
                          <th width="7%">St No.</th>
                          <th>Name</th>
