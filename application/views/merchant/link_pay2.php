                        ...
                        <div class="mt-auto">
                            <div class="row" style="margin-top: 10px !important;">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="result <?php echo date('ymdhisu') ?> d-none"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    // var logo_path = "<?php echo base_url(); ?>new_assets/img/salequick.png?random=<?php echo date('ymdhisu') ?>&nocache=<?php echo date('ymdhisu') ?>";
