...
<div class="sidebar-wrapper">   
  ...
  <div id="sidebar-menu" class="slimscrollleft">
    <ul>      
       <?php if($this->session->userdata('merchant_status')!='active' && $this->session->userdata('merchant_user_type')=='merchant' ) { ?>         
      <li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <?php if($this->session->userdata('register_type')=='api' && $this->session->userdata('merchant_user_type')=='merchant') { ?>         
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <?php }else if($this->session->userdata('employee_id')) { ?>
            <li>
