                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control" name="item_img" id="item_img" value="<?php echo $item_img; ?>">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" data-qty="" id="quantity" placeholder="Qty" required value="">
