            	...
            	<div class="col-sm-6 col-md-6 col-lg-6" style="margin-top: 5px !important;">
					<div class="row">
						<div class="custom_range_selector">
							<div id="daterange2" class="form-control" style="border: none !important;color: rgb(110, 110, 110) !important;font-family: Avenir-Heavy !important;">
...
<script>
    $(document).ready(function() {
        $("#daterange2 span").data({'d1':moment().subtract(5, 'days').format("YYYY-MM-DD") ,'d2' : moment().format("YYYY-MM-DD")})
        $('#daterange2 span').html(moment().subtract(5, 'days').format('MMMM D, YYYY') +' - '+moment().format('MMMM D, YYYY'));
    })
	...
	function getGraph() {
		...
		// $('#graph .metric1 h1').html('<i class="fa fa-spinner fa-spin"></i>');
	 	var jsonurl = '<?php echo base_url('merchant-panel'); ?>/graph/graph.php?filters[all]=1&start=<?php echo $last_date; ?>&end=<?php echo $date; ?>&employee=<?php echo 'all'; ?>&employee_id=<?php echo $employee_id; ?>';
	...
	function getTable() {
		...
		var jsonurl = '<?php echo base_url('merchant-panel'); ?>/graph/report.php?filters[all]=1&start=<?php echo $last_date; ?>&end=<?php echo $date; ?>&employee=<?php echo 'all'; ?>&table_emp_id=<?php echo $employee_id; ?>&merchant=<?php echo $merchant_id ; ?>';
