                            ...
                            <div class="row" style="margin-top: 10px !important;">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="copy_payment_link" disabled class="form-control" value="https://salequick.com/pay_now/<?php echo $merchant_key; ?>/<?php echo $id; ?>" style="background-color: transparent !important;border: none !important;padding-left: 0px !important;">
