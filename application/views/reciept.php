...
<body style="margin:0 auto;padding: 0;">
    <div class="main-box">
        <div class="invoice-wrap" id="printableArea">
            <div class="top-div">
                <?php //echo '<pre>';print_r($getEmail1);die; ?>
                <div class="float-left">
                    ...
                    <?php } else { ?>
                        <div style="display: inline-block; height: 51px; width: 51px; border-radius: 50%; border: 1px solid lightgray; text-transform: uppercase; background-color: white; color: #444; line-height: 51px; text-align: center; font-size: 25px;"><?php if($itemm[0]['business_dba_name']) echo ucfirst(substr($itemm[0]['business_dba_name'],0,1)); ?></div>
                    <?php } ?>

                    <?php if(!empty($getEmail1[0]['business_dba_name'])) { ?>
                        <h4 style="margin-bottom: 0px;font-size: 16px;"><?php echo $getEmail1[0]['business_dba_name']; ?></h4>
                    <?php } ?>

                    <?php if(!empty($getEmail1[0]['website'])) { ?>
                        <p style="margin-top: 0px;"><?php echo $getEmail1[0]['website']; ?></p>
                    <?php } ?>
                    <!-- <p style="margin-top: 0px;">www.salequick.com</p> -->
                    
                    <?php if(!empty($getEmail1[0]['business_number'])) { ?>
                        <!-- <p class="cl_fo_phone"><span style="color:#333;">Telephone:</span> <?php echo $getEmail1[0]['business_number']; ?></p> -->
                        <p><span style="color:#333;">Telephone:</span> <input class="cl_fo_phone" type="text" value="<?php echo $getEmail1[0]['business_number']; ?>" disabled="" style="border: none;background: transparent;"></p>
                    <?php } ?>
                </div>
            ...
            <div class="receipt_wraper"  >
             <div class="receipt-lcol" style="text-align: left;float: left;width: 50%;">
                <div class="sixty-div">
                    ...
                    <p style="text-transform: uppercase;color: #333;"><?php echo $name  ;?></p> </div>
                 <?php if(isset($sign)) {
					 	...
					 	?>
						<img src="<?php echo  base_url('uploads/sign/'); ?><?php echo $file; ?>" style="width: auto;height:auto;max-width: 100%;max-height: 198px;"/>
             ...
             <div class="receipt-rcol" style="text-align: left;float: left;width: 50%;">   <?php 
                    $itemLength=count(json_decode($item[0]['quantity']));
                    if($itemLength > 0 ) { 
                        ?>
                ...
                <div class="table-row">
                    ...
                    <p>
                        ...
                        <span class="right-div"><?php  echo (isset($tax))? '$ '.$tax: "0.00"; ?></span>
                    </p>
                    <?php } ?>
                    <p>
                    ...
                    <p>
                        ...
                        <span class="right-div"><?php if(!empty($transaction_id)){echo $transaction_id;} else { ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php } ?></span>
                    </p>
                    <p>
                        <span class="left-div">Reference :</span>
                        <span class="right-div"> <?php if(!empty($card_type)){ if($reference =='0'){echo 'N/A';}else {echo $reference; }} else { ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php }  ?></span>
                    </p>
                    <p>
                    ...
                    <?php if(!empty($name_card)){ ?> 
                        ...
                        <?php } ?>
                    <p><span class="left-div h4">Payment Status </span>
                        <span class="right-div" style="text-transform: uppercase;color:#4a90e2;margin-top:0;font-size: 14px;font-weight: 600;"> <?php echo $message; ?></span>
                    
                    
                    <!-- <p style="text-transform: uppercase;color:#4a90e2;margin-top:0;font-size: 14px;font-weight: 600;"><?php echo $message; ?></p> -->
                    </p>
            ...
            <div class="bottom-div">
                <!-- <div style="width: 100%;float: left;display: inline-block;margin-top: 20px;font-size:13px;font-style:italic;line-height: 20px;">
                    <span style="float:left;display: inline-block;width:100%;font-size: 13px !important;color: #878787;text-transform:uppercase;">* i agree to pay above total amount according to the cardholder agreement (Merchant agreement if credit voucher)</span>
                     <span style="color: #878787;text-transform:uppercase;">** important - please retain this copy for your records</span>
                </div> -->
                <div style="width: 100%;float: left;display: inline-block;">
                    <!--<a href="#" class="custom-btn" style="margin-left: 5px;">Print</a> -->
       ...
       <div class="footer-wraper" >
        <div >
            <div class="footer_address" style="float: left;">
                <!-- <span style="display: block;">Demo Auto</span>
                <span style="display: block;">Gomti Nagar Vibhuti Khand change</span> -->
