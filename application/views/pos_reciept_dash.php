                                                ...
                                                foreach($advPos as $pos){
                                                    if($pos['discount_amount'] > 0) { ?>
                                                        <tr class="item-table-border">
                                                            ...
                                                            <td width="20%" style="text-align: right;">$ <?php echo number_format(($pos['price']+$pos['discount_amount']),2); ?></td>
                            ...
                            <div class="row" style="margin-bottom: 10px !important;margin-top: 25px !important;">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <?php if($transaction_type == 'split') { ?>
                                        <div class="row">
                                            <div class="undergo-head">
                                                <span class="item-head">Split Payment Details</span>
                                                <div class="line-b4-head"></div>
                                            </div>
                                        ...
                                        <table class="payment-details-table" style="width: 100%">
                                            <tbody>
                                                <?php if($getEmail[0]['discount']!='' && $getEmail[0]['discount'] !='0' && $getEmail[0]['discount'] !='$0.00') {
                                                    ...
                                                    <tr>
                                                        <td width="50%" class="left">Total Discount (<? echo $getEmail[0]['discount']; ?>)</td>
                                                ...
                                                <?php } else {
                                                    if($transaction_type == 'split') { ?>
                                                        <tr>
                                                            <td width="50%" class="left">Sub Total</td>
                                                            <td width="50%" style="text-align: right;">$<?php echo number_format($getEmail[0]['full_amount'] - ($getEmail[0]['tax'] + $getEmail[0]['tip_amount'] + $getEmail[0]['other_charges']), 2); ?></td>
                                                        </tr>
                                                    <?php } else { ?>
                                                        <tr>
                                                            <td width="50%" class="left">Sub Total</td>
                                                ...
                                                <?php  if( $getEmail[0]['tax'] > 0) { ?>
                                                    <tr>
                                                        ...
                                                        <td width="50%" style="text-align: right;">$<?php echo number_format($getEmail[0]['tax'],2);?></td>
                                                    </tr>
                                                <?php } ?>
                                                ...
                                                <?php if($getEmail[0]['other_charges'] > 0) { ?>
                                                    <tr>
                                                        <td width="50%" class="left"><?php echo $getEmail[0]['otherChargesName']; ?></td>
                                                        <td width="50%" style="text-align: right;">$<?php echo number_format($getEmail[0]['other_charges'],2); ?></td>
                                                    </tr>
                                                <?php } ?>
                                                
                                                <tr>
                                                    <td width="50%" class="left">Total Amount</td>
                                                    <td width="50%" style="text-align: right;">$<?= ($transaction_type == 'split') ? number_format($full_amount,2) : number_format($amount, 2) ; ?></td>
                                                </tr>
                                                <?php if($transaction_type != 'split') { ?>
                                                    <tr>
                                                        <td width="50%" class="left">Transaction ID</td>
                                                        <td width="50%" style="text-align: right;"><?php echo $transaction_id; ?></td>
                                                    </tr>

                                                    <?php if(!empty($reference)) { ?>
                                                        <tr>
                                                            <td width="50%" class="left">Reference</td>
                                                            <td width="50%" style="text-align: right;"><?php if($reference == "") { echo '--'; } elseif($reference =='0' && $reference!="") { echo 'N/A'; } else { echo $reference; } ?></td>
                                                        </tr>
                                                    <?php } ?>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="50%" class="left">Card Last 4 digit</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="50%" style="text-align: right;text-transform: uppercase;color:#4a90e2;margin-top:0;font-size: 14px;font-weight: 600;"><?php echo $getEmail[0]['status'] ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
