     ...
     <option <?php echo (@$status=="confirm")?'selected="selected"':''?> value="confirm">Confirm</option>
                                   ...
                                   <div class="col-sm-2 form-group">
                                                            <div class="input-daterange input-group" id="date-range">
                                                                <input class="form-control" required="required"  value="<?php echo $reposrint_date ?>" name="start_date" type="text" autocomplete="off"  placeholder="Select Date">
...
<form onsubmit="return validate(this);" method="post" action="<?php echo base_url('dashboard/funding_status_post');?>" >
          <div class="row">
                    ...
                    <input class="form-control" required="required"  value="<?php echo $reposrint_date ?>" name="date" type="hidden" autocomplete="off"  placeholder="Select Date">
...
$count++;
  ...
  <?php
    ...
    if($a_data['totalAmount']>0){
        $totalFees=$a_data['feesamoun']+$a_data['f_swap_Text']+$a_data['f_swap_Invoice']+$a_data['f_swap_Recurring']+$a_data['feesemail']+$a_data['monthly_fees'];
    }
?>
...
<td>  <h5 class="no-margin text-bold text-danger" > $<?php echo number_format(($a_data['totalAmount']-$totalFees),2); ?> </h5> </td>
<td><?php
...
<td>
            ...
            <button data-toggle="modal" data-target="#amount-modal" data-amount="<?php echo $a_data['totalAmount']-$totalFees?>" data-date="<?php echo $a_data['date_c'];?>" data-mid="<?php echo $a_data['id'];?>" id="setamount" class="btn btn-sm btn-warning"><i class="ti-eye"></i> Change Status</button>
                                ...
                                <div class="row">
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                      ...
                                                      <div class="form-group row">
                                                          <label class="col-md-5 col-form-label">Payable Amount</label>
                                                          <div class="col-md-7">
                                                              <input type="text" class="form-control" readonly="readonly" name="PayableAmount" id="PayableAmount"  required value="">
                                                          </div>
                                              ...
                                              <div class="col-md-6">
                                                      ...
                                                      <div class="form-group row">
                                                          ...
                                                          <div class="col-md-7">
                                                              <input type="text" class="form-control" name="Hold_Amount" id="Hold Amount"  required value="0">
                                                          </div>
                                                      </div>
                                     ...
                                     <div class="col-md-12">
                                        ...
                                        <button class="btn btn-primary " type="submit" name="mysubmit" value="Search" ><i class=" ti-search"></i> Submit</button>
                                     </div>
