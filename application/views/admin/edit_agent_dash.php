                                ...
                                <div class="row" style="margin-top: 10px;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" name="name" id="name"  required value="<?php echo (isset($name) && !empty($name)) ? $name :'';?>">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Last Name</label>
                                                    <input type="text" pattern="[a-zA-Z\s]+" autocomplete="off" class="form-control" name="last_name" id="last_name"  required value="<?php echo (isset($last_name) && !empty($last_name)) ? $last_name :'';?>">
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" id="hidden_assign_merchant" name="hidden_assign_merchant" value="<?php echo $assign_merchant; ?>">
                                        <div class="form-group">
                                            <label for="">Mobile No <i class="text-danger">*</i> </label>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" autocomplete="off" class="form-control us-tin-no" id="ssn" required maxlength="11" value="<?php echo (isset($ssn) && !empty($ssn)) ? $ssn : ''; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Sign Up Bonus <i class="text-danger">*</i> </label>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Profit Share <i class="text-danger">*</i> </label>
                                        ...
                                        <div class="form-group">
                                            <label for="">Gateway Fee (Per Merchant) <i class="text-danger">*</i> </label>
                                        ...
                                        <div class="form-group">
                                            <label for="">Buy Rate (Per Transaction) <i class="text-danger">*</i> </label>
                                        ...
                                        <div class="form-group">
                                            <label for="">Buy Rate Volume (in %) <i class="text-danger">*</i> </label>
                                        ...
                                        <?php if($loc=='edit_agent') { ?>
                                            <div class="form-group">
                                                <label for="" style="height: 20px !important;"></label>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" name="reset_password" value="0" id="reset_password" style="width: 17px !important;height: 17px !important;margin-top: 5px;">
                                                    <label for="reset_password" style="font-size: 15px !important;">Reset Password for this Agent?</label>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        // function updateDataTableSelectOnLoad(table){
        ...
        function getSelected(){
            // var tbl = $('#example');
            // var checkedId = table.rows().data();

            // tbl.columns().checkboxes.selected()[0];
            ...
            table.rows().iterator('row', function(context, index){
                var node = $(this.row(index).node()).children().children();
                // if(node.checked)
                if(node.prop('checked') == true){
                    // console.log(node);return false;
                    checkedData += node.val() + ',';
                }
            });
            console.log(checkedData);

            if(checkedData != '') {
                checkedData = checkedData.replace(/,\s*$/, "");
                $('#hidden_assign_merchant').val(checkedData);
            }
        }
    ...
    $('#btn_login').click( function(event) {
        ...
        // if(Rowarray.length) {
        //     datanew+='&chkstatus[]='+Rowarray;
        // } else {
        //     datanew+='&chkstatus[]=';
        // }

        // console.log(datanew);
        // console.log(datanew);return false;
        // console.log($('#btn_login').val());return false; 
