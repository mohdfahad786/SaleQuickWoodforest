                        ...
                        <tbody>
                            ...
                            foreach($mem as $a_data) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $item = $this->admin_model->data_get_where_month("agent_payout", array("merchant_id" => $a_data['id'],));
                                        echo '$'.$item[0]['amount'].'&nbsp;&nbsp;('.$item[0]['year'] .'/'. $item[0]['month'] .')'; ?>
                                    </td>
                                    <td><a class="btn_custom_link" id="edit-bt" href="<?php  echo site_url('Agent/add_payout_agent/' . $a_data['id']) ?>"><span class="fa fa-plus"></span>  Add</a></td>
                                    <td><a class="btn_custom_link" id="edit-bt" href="<?php  echo site_url('Agent/all_payout/' . $a_data['id']) ?>"><span class="fa fa-eye"></span>  View All Payout</a></td>
                                </tr>
                                <?php $i++;
                            } ?>
                        </tbody>
