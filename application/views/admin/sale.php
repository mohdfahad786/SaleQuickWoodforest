 ...
 // console.log(start+'-----'+end+employee);  
	$.ajax({
		...
		success: function (dataJson)
		{
			...
			console.log(fullData.getDashboardData);
			// console.log("Hi"); 
...
function getGraph(start, end) {
	...
	// $('#sales_summery h1, #sales_summery h2').html('&nbsp;');
	// $('#sales_summery .metric1 h1').html('<i class="fa fa-spinner fa-spin"></i>');
	...
	$.getJSON(jsonurl, function(data) {
		if (data.length != 0) imGraph('sales_summery', data); 
	});
}
