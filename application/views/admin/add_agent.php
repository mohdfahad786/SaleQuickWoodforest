      ...
      <div class="row">
        <div class="col-12">
          <div class="back-title m-title"> 
            ...
            <br><small style="color:red;"><?= validation_errors(); ?></small>
          </div>
        </div>
      </div>
      <?php
                ...
                <div class="row  responsive-cols f-wrap f-auto">
                  ...
                  <div class="col mx-253">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="Phone" name="mobile" id="mob_no_new" value="<?php echo (isset($mobile) && !empty($mobile)) ? $mobile : set_value('mobile');?>" required type="text">
                    </div>
                  </div>
                  <div class="col mx-253">
                    <div class="form-group">
...
$('#btn_login').click( function(event) {
  ...
  // console.log(Rowarray); 
  // console.log(datanew, Rowarray);return false;
  ...
  $.ajax({
        ...
        success: function(data) {
            if(data.trim()=='200') {
                // $('small').html('Success');
                window.location.replace('<?php echo base_url('dashboard/all_agent'); ?>');
            } else {
                $('small').html(data); 
            }
            console.log(data); 
