...
<div class="col-md-12">
                            ...
                            <h2 class="m-b-20">View All Support Request</h2></div>

                    </div>  

  <div class="card-box">

    <form method="post" action="<?php echo base_url('customer/all_support');?>" >
...
<td> <?php echo $a_data['add_date'] ?></td>
   ...
   <td>
            ...
            <button data-toggle="modal" data-target="#view-modall" data-id="<?php echo $a_data['id'];  ?>" id="getcredt" class="btn btn-sm btn-info"><i class=" ti-eye "></i> View</button>
