            ...
            <table style="max-width: 351px;width: 100%;font-size: 14px;clear: both;margin: 0 auto" cellspacing="0">
                ...
                <tbody  style="border-bottom: 1px solid #ddd;"  > <!--  -->
                  ...
                  <tr>
                    ...
                    <td style="padding: 5px 1px;text-align: right;font-weight: 600;">$ <?=$total_amount[$i]; ?></td>
                  </tr>
                <?php }?>
                  <!-- <tr>
              ...
              <div class="irm-pay-detail">
                ...
                <div class="irm-pay-detail">
                  ...
                  <p class="pos_Status_c"><span>Refunded Amount :</span> <b class="srpttlAmt"><?php echo  $refundData[0]['amount']; ?></b></p>
                  <p><span>Transaction ID :</span> <?php echo $refundData[0]['transaction_id'];  ?></p>
                  ...
                  <p><span>Customer Name :</span> <?php echo (isset($invoice_detail_receipt[0]->name_card) && !empty($invoice_detail_receipt[0]->name_card))? ucfirst($invoice_detail_receipt[0]->name_card) : "-"; ?></p>
                  <?php } ?>
