...
-->   
<div class="col-md-12">
                            <h2 class="m-b-20">View All Subadmin</h2></div>
                    </div>  
...
<td> <a class="btn btn-warning" id="edit-bt" href="<?php  echo site_url('dashboard/edit_subadmin/' . $a_data['id']) ?>"><i class="fa fa-pencil"></i> </a>
...
<button class="btn btn-danger" onclick="subadmin_delete(<?php echo $a_data['id'];?>)"><i class="fa fa-trash"></i></button>
