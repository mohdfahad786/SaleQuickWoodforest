...
<script src="<?php echo base_url('merchant-panel'); ?>/graph/app2.min.js"></script>
...
currency_symbol = '$';
  ...
  <div class="card-box col-md-12">
    <div class="row" style="">
      <!-- <div class="col-md-6">
        <div id="daterange" class="selectbox"> <i class="fa fa-calendar"></i> <span> <?php echo date("m-d-Y"); ?></span> <b class="caret"></b> </div>
      </div>  -->
      ...
      <div class="col-md-12">
        <div class="portlet">
          <div class="portlet-heading portlet-default">
            <div class=" col-sm-8 ">
              <h3 class="portlet-title"> DAILY GROSS SALES </h3>
              <div class="clearfix"></div>
             <!--  <p>Gross sales on Jan. 2, 2015 were $755.25. This was up 63.92% from the prior Friday.</p> -->
            </div>
...
?>
                ...
                <?php echo date("M, d, Y",strtotime("-1 days")); ?> <i class="fa fa-circle" aria-hidden="true" style="color:  #A7BBC4"></i> <br/>
                <?php echo date("M, d ,Y",strtotime("-8 days")); ?> <i class="fa fa-circle-o" aria-hidden="true" style="color: #00DFEF"></i> </strong></p>
            </div>
            <div class="clearfix"></div>
  ...
  <div class="card-box col-md-12">
    <div class="row" style="">
      <div class="col-md-12">
        <div class=" clearfix"></div>
        <div class=" col-sm-8 ">
          <h3 class="portlet-title"> Weekly Gross Sales </h3>
          <div class="clearfix"></div>
        <!--   <p>Gross sales for the week of Jan. 2, 2015 were $3,000.75 This was down - 12.00% from the prior week.</p> -->
        </div>
        <div class=" col-sm-4 pull-right text-right">
          <p> <strong> <?php echo $this_week_sd ?> - <?php echo $this_week_ed ?> <i class="fa fa-circle" aria-hidden="true" style="color: #00DFEF"></i><br/>
           <?php echo $this_week_ed1 ?> - <?php echo $this_week_sd1 ?> <i class="fa fa-circle-o" aria-hidden="true" style="color: #A7BBC4"></i></strong></p>
          <div class=" clearfix"></div>
        </div>
        <div class=" clearfix"></div>
        <hr/>

       <!--  <div class="page page-white portlet-body">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="portlet">
          <div class="portlet-heading portlet-default">
            <div class=" col-sm-8 ">
              <h3 class="portlet-title"> YEARLY GROSS SALES </h3>
              <div class="clearfix"></div>
             <!--  <p>Gross sales on Jan. 2, 2015 were $755.25. This was up 63.92% from the prior Friday.</p> -->
            </div>
            <div class=" col-sm-4 pull-right text-right">
              <p><strong><?php echo date("Y"); ?> <i class="fa fa-circle" aria-hidden="true" style="color:  #81D33F"></i> <br/>
                <?php echo date("Y",strtotime("-1 year")); ?> <i class="fa fa-circle-o" aria-hidden="true" style="color: #FFB30F"></i> </strong></p>
            </div>
            <div class="clearfix"></div>
            <ul class="nav nav-pills navtab-bg nav-justified pull-right">
            </ul>
