                ...
                <div class="col-12">
                    <div class="grid grid-chart" style="width: 100% !important;">
                        <div class="grid-body d-flex flex-column">
                            <form method="POST" action="<?php echo base_url('merchant_document/edit_sub_ongoing_note/'.$merchant_id.'/'.$mid.'/'.$on_id.'/'.$note_sr_id); ?>">
                                <div class="mt-auto">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6 col-lg-6" style="margin: auto !important;">
                                            <div class="form-title">Edit Sub Ongoing Note for '<?php echo !empty($merchant->business_dba_name) ? $merchant->business_dba_name : $merchant->email; ?>'</div>
                                            ...
                                            <div class="form-group">
                                                <label>Subject</label>
                                                <input class="form-control" name="subject" id="subject" placeholder="Subject" value="<?php echo $ongoing_notes->subject ?>" readonly type="text" autocomplete="off">
                                            </div>

                                            <input type="hidden" name="sub_id" id="sub_id" value="<?php echo $sub_note_id->subNote_sr_id ?>">
                                            <div class="form-group">
                                                <label>Sub Ongoing Note</label>
                                                 <textarea class="form-control" name="note" id="note" placeholder="Ongoing Note" rows="8" required><?php echo $sub_note->sub_note ?></textarea>
                                            </div>
    ...
    function ajax_file_upload(file_obj) {
        ...
        for (var i = 0; i < file_obj.length; i++) {
            ...
            $.ajax({
                ...
                type: 'POST', 
                dataType: "json",
                url: "<?php echo base_url('merchant_document/upload_pdf_file_of_edit/'.$merchant_id); ?>",
                contentType: false,
                processData: false,
                data: form_data,
