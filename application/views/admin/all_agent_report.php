      ...
      <div class="row">
        <div class="col-12">
          <div class="back-title m-title"> 
            <span>View All Agent Report</span>
          </div>
        </div>
      </div> 
      <div class="row">
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!--  <td> <?php if($a_data['edit_permissions']=='1') {echo 'Yes';} elseif($a_data['edit_permissions']=='0'){ echo 'No';} ?></td>
                      ...
                      <td> 
                        <?php 
                        $item = $this->admin_model->data_get_where_month("agent_payout", array(
      "merchant_id" => $a_data['id'],));
   echo '$'.$item[0]['amount'].'&nbsp;&nbsp;('.$item[0]['year'] .'/'. $item[0]['month'] .')';
       ?>
        
      </td>
                       <td> <a class="dropdown-item invoice_pos_list_item_vw_recept" id="edit-bt" href="<?php  echo site_url('Agent/add_payout_agent/' . $a_data['id']) ?>">
                              <span class="fa fa-plus"></span>  Add
                            </a></td>
                        <td><a class="dropdown-item invoice_pos_list_item_vw_recept" id="edit-bt" href="<?php  echo site_url('Agent/all_payout/' . $a_data['id']) ?>">
                              <span class="fa fa-eye"></span>  View All Payout
                            </a></td>
                      <td> 
