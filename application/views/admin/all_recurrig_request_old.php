...
-->   
<div class="col-md-12">
                            <h2 class="m-b-20"> View All Send Recurring Payment Request</h2></div>
                    </div>  
  <div class="card-box">
    <form method="post" action="<?php echo base_url('dashboard/all_recurrig_request');?>" >
                        <div class="row">
                            <div class="col-md-4">
  ...
  <!-- <div class="form-group row date datetimepicker col-md-5">
                                    ...
                                    <input class="form-control" name="curr_payment_date" type="text" autocomplete="off"  placeholder="Select Start Date">
                                        <span class="input-group-addon bg-primary b-0 text-white" style="background-color: #3bafda !important;">to</span>
                                                                <input class="form-control" name="end" type="text" autocomplete="off"  placeholder="Select End Date">
                                                            </div>
                                                        </div>
...
<!-- <td> <a id="edit-bt" href="<?php  echo base_url('merchant/edit_request/' . $a_data['rid']) ?>"><i class="fa fa-pencil"></i> </a></td>
