...
<body class="fixed-left">
 ...
 echo $a_data['month'] .'/'. $a_data['year'] ;
       ?>
        
      </td>
                       <td> <a class="dropdown-item invoice_pos_list_item_vw_recept" id="edit-bt" href="<?php  echo site_url('Agent/edit_payout_agent/' . $a_data['id'].'/'.$a_data['merchant_id']) ?>">
                              <span class="fa fa-pencil"></span> 
                            </a></td>
                       <!--  <td><a class="dropdown-item invoice_pos_list_item_vw_refund" href="#" onclick="subadmin_delete('<?php echo $a_data['id'];?>')">
