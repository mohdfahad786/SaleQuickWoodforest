...
<div class="page-content-wrapper">
    <div class="page-content-wrapper-inner">
        ...
        <div class="content-viewport d-none" id="base-contents">
            ...
            <form class="row" method="post" action="<?php echo base_url('AgentRevenue/transaction'); ?>" style="margin-bottom: 20px !important;">
                <div class="table_custom_range_selector" style="width: auto;margin-right: 10px;margin-left: 20px !important;">
                    ...
                    <table id="datatable" class="hover row-border pos-list-dtable" style="width:100%">
                        ...
                        <tbody>
                            <?php foreach($mem as $a_data) { ?>
                                <tr>
                                   <td><?php echo $a_data['merchant_name']; ?></td>
                                    <td>Card Present</td>
                                    ...
                                    <td class="show_revenue"><h5 class="no-margin text-bold text-danger">$<?php echo  $a_data['revenue']; ?></h5></td>
                                   
                                    <td><?php echo $a_data['date'] ?></td>
                                     <td><?php echo $a_data['settlement_date'] ?></td>
                                    <td></td>
                                </tr>
                                <tr class="hidden_row">
                                    <td></td>
                                    <td class="rev_td"><span>InterchangeFee</span><br>$<?php echo  $a_data['interchangeFee']; ?></td>
                                    <td class="rev_td"><span>NetworkFees</span><br>$<?php echo  $a_data['networkFees']; ?></td>
                                    <td class="rev_td"><span>Buy Rate</span><br>$<?php echo  $a_data['buy_rate']; ?></td>
                                    <td class="rev_td"><span>Payfac Revenue</span><br>$<?php echo  ($a_data['revenue'] - ($a_data['interchangeFee']+$a_data['networkFees']+ $a_data['buy_rate'])); ?></td>
                                    <td></td>
                                </tr>
                            <?php } ?>
                        </tbody>
