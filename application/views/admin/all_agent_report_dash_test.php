...
<div class="page-content-wrapper">
    <div class="page-content-wrapper-inner">
        ...
        <div class="content-viewport d-none" id="base-contents">
            ...
            <?php $count = 0; ?>
            <form class="row" method="post" action="<?php echo base_url('Agent_report/all_agent_report'); ?>" style="margin-bottom: 20px !important;margin-top: 10px !important;">
                    ...
                    <table id="datatable" class="hover row-border pos-list-dtable" style="width:100%">    
                        ...
                        <tbody>
                            ...
                            <tr id="row_11">
                                ...
                                <td>
                                    <a href="javascript:void(0)" data-value4="<?php echo number_format($a_data['m_cost'],2) ?>" data-value5="<?php echo number_format($a_data['m_buy_rate'],2) ?>" data-value6="<?php echo number_format($a_data['m_gateway_fee'],2) ?>" id="getCost" title="View Details">$<?php echo number_format($a_data['m_cost'],2) ?></a>
                                </td>
                                <td>
