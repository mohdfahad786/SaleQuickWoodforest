	...
	<div class="row">
				...
				<div class="irm-to-sign">
					<!-- <pre><?php echo $invoice_detail_receipt[0]->sign; ?></pre> -->
				 	<?php   
						...
						<p ><?=$invoice_detail_receipt[0]->name?></p>
					<?php	}
		...
		<div class="col-md-6">
			...
			<div class="irm-pay-detail">
				...
				<div class="irm-pay-detail">
					<!-- <?php echo $invoice_detail_receipt[0]->late_fee; ?> -->
				 	<?php 
				 		...
				 		// if(($invoice_detail_receipt[0]->late_fee) || ($merchant_data[0]->late_fee_status > 0 && date('Y-m-d') > $payment_date)) { 
				 		if(!empty($invoice_detail_receipt[0]->late_fee)) { 
	 				?>
						<p><span>Late Fee :</span> <?= !empty($invoice_detail_receipt[0]->late_fee) ? '$' .$invoice_detail_receipt[0]->late_fee : '' ?></p>
					<?php } ?>

					<p><span>Tip Amount :</span> <b class="srpttlAmt"><?php echo (isset($invoice_detail_receipt[0]->tip_amount) && !empty($invoice_detail_receipt[0]->tip_amount))? '$'.$invoice_detail_receipt[0]->tip_amount : "-"; ?></b></p>
...
<?php if(!empty($invoice_detail_receipt[0]->name_card) ){echo ucfirst($invoice_detail_receipt[0]->name_card);} elseif(!empty($invoice_detail_receipt[0]->name)){ echo ucfirst($invoice_detail_receipt[0]->name); }?>

					<?php //echo (isset($invoice_detail_receipt[0]->name_card) && !empty($invoice_detail_receipt[0]->name_card))? ucfirst($invoice_detail_receipt[0]->name_card) : "-"; ?>
			...
			// echo '<h1>'.$refundedAmt.'</h1>'; 
			// echo $invoice_detail_receipt[0]->amount; 
