                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td width="30%" style="text-align: right;font-size: 18px;font-weight: 600 !important;">
                                <?php if($invoice_detail_receipt[0]->payment_type == 'straight') {
                                    if($itemLength > 0) {
                                        echo '$'.number_format($invoice_detail_receipt[0]->sub_total,2); //invoice condition
                                    } else {
                                        $subttl1=$invoice_detail_receipt[0]->amount;
                                        $subttl2=$invoice_detail_receipt[0]->tax; 
                                        $late_fee=$invoice_detail_receipt[0]->late_fee;
                                        $other_charges = !empty($invoice_detail_receipt[0]->other_charges) ? $invoice_detail_receipt[0]->other_charges : '0';
                                        echo '$'.number_format(($subttl1 - $subttl2 - $late_fee - $other_charges),2); //simple invoice condition
                                    }
                                } else if($invoice_detail_receipt[0]->payment_type == 'recurring') {
                                    $subttl1=$invoice_detail_receipt[0]->amount;
                                    $subttl2=$invoice_detail_receipt[0]->tax; 
                                    $late_fee=$invoice_detail_receipt[0]->late_fee;
                                    $other_charges = !empty($invoice_detail_receipt[0]->other_charges) ? $invoice_detail_receipt[0]->other_charges : '0';
                                    echo '$'.number_format(($subttl1 - $subttl2 - $late_fee - $other_charges),2);
                                } ?>
                            </td>
                        </tr>
                        <?php if($itemLength > 0 && $invoice_detail_receipt[0]->tax > 0 ) { ?>
                            <tr>
                                ...
                                <td width="30%" style="text-align: right;font-size: 18px;font-weight: 600 !important;">
                                    <?php echo (isset($invoice_detail_receipt[0]->tax) && !empty($invoice_detail_receipt[0]->tax))? '$'.number_format($invoice_detail_receipt[0]->tax,2) : "-"; ?>
                                </td>
                            </tr>
                         <?php } ?>
                            ...
                            <span style="font-family: Avenir-Heavy;font-size: 18px;">Refunded</span><br>
                                <?php 
                                    ...
                                    <span class="" style="font-family: AvenirNext-Medium !important;font-size: 16px !important;">
                                        <span class="status_success"><?php $refundedAmt += $rowdata['amount'];  if($rowdata['amount']!="") { echo '$'.number_format($rowdata['amount'],2); }else{ echo '$0'; }  ?>,</span>
                                        <span>On</span>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <table class="payment-details-table" style="width: 100%">
                    <tbody>
                        ...
                        $payment_date = date('Y-m-d', strtotime($invoice_detail_receipt[0]->recurring_pay_start_date. ' + '.$late_grace_period.' days'));
                        if(!empty($invoice_detail_receipt[0]->late_fee)) {
                        ?>
                            <tr>
                                <td width="50%" class="left">Late Fee</td>
                                <td width="50%" style="text-align: right;"><?= !empty($invoice_detail_receipt[0]->late_fee) ? '$' .number_format($invoice_detail_receipt[0]->late_fee,2) : '' ?></td>
                            </tr>
                        <?php } ?>
                        
                        <?php if($merchant_data[0]->tip > 0) { ?>
                            <tr>
                                <td width="50%" class="left">Tip Amount</td>
                                <td width="50%" style="text-align: right;"><?php echo (isset($invoice_detail_receipt[0]->tip_amount) && !empty($invoice_detail_receipt[0]->tip_amount))? '$'.number_format($invoice_detail_receipt[0]->tip_amount,2) : "-"; ?></td>
                            </tr>
                        <?php } ?>
                            
                        <tr>
                            <td width="50%" class="left">Total Amount</td>
                            <td width="50%" style="text-align: right;"><?php echo (isset($invoice_detail_receipt[0]->amount) && !empty($invoice_detail_receipt[0]->amount))? '$'.number_format($invoice_detail_receipt[0]->amount,2) : "-"; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="text-align: right;">
                                <?php if(!empty($invoice_detail_receipt[0]->status) && $invoice_detail_receipt[0]->status=='Chargeback_Confirm' ){
                                    echo 'confirm'; 
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" style="padding-left: 0px !important;">
                           ...
                           <!--  <form id="sRefform" action="<?php echo base_url();  ?>pos/refund" method="post"  style=" display: inline; "> -->
                                 ...
                                 <form id="sRefform" action="<?=base_url();?><?php if($invoice_detail_receipt[0]->processor_name=='PAYROC') { echo 'payroc/refund_invoice'; } else{ echo "pos/refund";} ?>"  style="display: inline;" method="post">
                                ...
                                <input class="form-control" name="refundfor" id="" value="<?php echo $invoice_detail_receipt[0]->payment_type; ?>"  type="hidden" required>
