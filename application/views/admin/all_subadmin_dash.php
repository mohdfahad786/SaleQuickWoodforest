                                    ...
                                    <td>
                                        <div class="dropdown dt-vw-del-dpdwn">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item invoice_pos_list_item_vw_recept" id="edit-bt" href="<?php  echo site_url('dashboard/edit_subadmin/' . $a_data['id']) ?>"><span class="fa fa-pencil"></span>  Edit</a>
                                                <a class="dropdown-item invoice_pos_list_item_vw_refund" href="#" onclick="subadmin_delete('<?php echo $a_data['id'];?>')"><span class="fa fa-trash"></span>  Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
