                ...
                <div class="col-sm-6 col-md-6 col-lg-6" style="margin: auto !important;">
                    <div class="grid grid-chart" style="width: 100% !important;">
                        <div class="grid-body d-flex flex-column">
                            <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('merchant_document/add_sub_ongoing_note/'.$merchant_id.'/'.$creator_id.'/'.$note_sr_id); ?>">

                                <div class="mt-auto">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-title">Add Sub Ongoing Note for '<?php echo !empty($merchant->business_dba_name) ? $merchant->business_dba_name : $merchant->email; ?>'</div>
                                            <input type="hidden" name="merchant_id" value="<?php echo $merchant_id ?>" required>
                                            <div class="form-group">
                                                <label>Subject</label>
                                                
                                                <input class="form-control" name="subject" id="subject" placeholder="Subject" value="<?php echo $subject->subject; ?>" required type="text" autocomplete="off" readonly>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label>Ongoing Sub Note*</label>
                                                <textarea class="form-control" name="note" id="note" placeholder="Ongoing Sub Note" rows="5" required></textarea>
                                            </div>
                                            <div class="form-group" style="margin-bottom: 0 !important;">
                                                ...
                                                <input type="hidden" name="sub_note_id" id="sub_note_id" value="<?php echo $sub_note_id ?>">
    ...
    function ajax_file_upload(file_obj) {
        ...
        for (var i = 0; i < file_obj.length; i++) {
            ...
            //let li_el=document.querySelector('#'+file_name);
                    ...
                    //return false;
            var sub_note_id = $('#sub_note_id').val();
            var form_data = new FormData();                  
            form_data.append('file', file_obj[i]);
            form_data.append('sub_note_id', sub_note_id);
            $.ajax({
                xhr: function() {
                ...
                type: 'POST', 
                dataType: "json",
                url: "<?php echo base_url('merchant_document/upload_sub_pdf_file/'.$merchant_id); ?>",
                contentType: false,
                processData: false,
                data: form_data,
