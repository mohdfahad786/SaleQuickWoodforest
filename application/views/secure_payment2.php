...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script src="<?php echo base_url();?>new_assets/js/payment_script.js"></script>
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width: 565px) {
            form.cardPaymentFormWrapper .pay-detail, form.cardPaymentFormWrapper .bill-address {
...
<body>
    ...
    <div class="invoice-wrapper">
        <div class="irm-header-inner">
            <div class="row">
                <div class="col-12 text-center" style="margin-bottom: 15px;"><h4><strong>Pay Now - <?= $itemm[0]['business_dba_name'] ?></strong></h4></div>
            </div>
            <form class="cardPaymentFormWrapper row" action="<?php echo base_url('pay_now/card_payment') ?>" method="post">
                <div class="row">
                ...
                <div class="card-form row">
                    <div class="col-sm-6 col-lg-6 col-md-6">
                        <div class="bill-address">
                            ...
                            <div class="form-group">
                                ...
                                <input id="card__email" name="email_id" class="form-control required" type="email">
                            </div>
                            <div class="form-group">
                                <label for="card__phone" class="movbale">Phone No</label>
                                <input id="card__phone" name="mobile_no" class="form-control phone required" type="text">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="card__city" name="city" class="form-control required" type="text" style="height: 35px !important;">
                            </div>
                            <div class="mycl-wrapper responsive-cols flex-row">
                                <div class="flex-col">
                    ...
                    <div class="col-sm-6 col-lg-6 col-md-6">
                        <div class="pay-detail" style="display: inline-block;width: 100%;">
                            ...
                            <div class="form-group">
                                <label for="pay_amount" class="amount">Amount (in $)</label>
                                <input id="pay_amount" name="amount" class="form-control required" type="text" onkeypress="return isDecimal(event)">
                            ...
                            <div class="mycl-wrapper responsive-cols flex-row">
                                <div class="flex-col">
                                    <div class="form-group fg-half">
                                        ...
                                        <input autocomplete="off" id="card__validutil"  data-yr='<?php echo json_encode($yeardata);?>' name="exp_month"  placeholder="MM/YY" class="form-control required ddmm" type="text" maxlength="5">
                                    </div>
                                </div>
                                <div class="flex-col">
                                    <div class="form-group fg-half">
                                        <label for="card__cvv" class="movbale">CVV</label>
                                        <input id="card__cvv" class="form-control required cvv" type="text"  name="cvv" maxlength="4">
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <button type="button" class="btn btn-first d-colors cardPaySignModalTglr" style="border-radius: 20px;margin-top: 15px !important;"> Complete The Payment</button>
                            </div>
                        </div>
                    </div>
    ...
    <div class="cp-footer">
        <div class="row slogan">
            <div class="col-sm-4" >
                 <span style="display: block;color: #404040;font-weight: 600;"><?= $itemm[0]['business_dba_name'] ?></span> <span style="display: inline-block;color:#666"> <?= $itemm[0]['address1'] ?></span>
            </div>
