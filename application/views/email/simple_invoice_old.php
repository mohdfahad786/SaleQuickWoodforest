                   ...
                   <table width="100%" border="0" style="border-collapse: collapse;border: 0px;">
                        <tr>
                            ...
                            <th style="text-align:center;color: #7e8899;text-transform: uppercase;font-weight: 500;font-size: 13px;border: 0px;text-aliign:left;">Amount</th>
                                        ...
                                        <tr>
                                            <td style="color: #7e8899;font-size:13px;"><?php echo $name ;?></td>
                                            <td style="color: #7e8899;font-size:13px;"><?php echo $email_id ;?></td>
                                            <td style="color: #7e8899;font-size:13px;"><?php echo $mobile_no ;?></td>
                                            <td style="color: #7e8899;font-size:13px;"><?php echo $due_date ;?></td>
                                            <td style="color: #7e8899;font-size:13px;">$<?php echo number_format($amount,2) ;?></td>
                                        </tr>
