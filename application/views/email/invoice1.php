...
<html>
    ...
    <body style="margin:0 auto;padding: 0;font-family: 'Open Sans', sans-serif;width: 100%;height: 100%;position: relative;">
        ...
        <div class="main-box" style="background-image: linear-gradient(#<?= $msgData['getEmail1'][0]['color'] ?>,#<?= $msgData['color'] ?>);padding: 80px 0px 10px 0px;background-repeat: no-repeat;width: 100%;height: 100%;display: inline-block;background-size: 100% 190px;background-position: center top;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" id="templateColumns" style="margin: auto;width: 100%;">
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top" width="50%" class="templateColumnContainer" style="text-align: right !important;">
                                ...
                                <?php if($msgData['getEmail'][0]['payment_type'] == 'recurring') { ?>
                                    <p class="mail-phone-text" style="margin-top: 0px !important;">Recurring <?= ($msgData['getEmail'][0]['recurring_type'] == 'daily' ? 'Daily' : ($msgData['getEmail'][0]['recurring_type'] == 'weekly' ? 'Weekly' : ($msgData['getEmail'][0]['recurring_type'] == 'biweekly' ? 'Bi Weekly' : ($msgData['getEmail'][0]['recurring_type'] == 'monthly' ? 'Monthly' : ($msgData['getEmail'][0]['recurring_type'] == 'quarterly' ? 'Quarterly' : ($msgData['getEmail'][0]['recurring_type'] == 'yearly' ? 'Yearly' : ''))))))?> Invoice No <?= $msgData['no_of_invoice']?> of <?= ($msgData['getEmail'][0]['recurring_count'] == -1 ? '&infin;' : $msgData['getEmail'][0]['recurring_count'])?></p>
                                <?php } ?>
                            </td>
                        </tr>
                        
                        <?php if(!empty($msgData['item_detail']['p_id'])) { ?>
                                ...
                                <td valign="top" colspan="2" width="100%" class="templateColumnContainer" style="margin-top: 15px !important;">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="item-details-table" style="width: 100%">
                                            ...
                                            <tbody>
                                                <?php if(!empty($msgData) && array_key_exists('item_detail', $msgData)){
                                                    ...
                                                    foreach ($item_name1 as $rowpp) {
                                                        if($quantity1[$i] > 0 && ucfirst($item_name1[$i])!='Labor'){ ?>
                                                            <tr class="item-table-border">
                                                                ...
                                                                <td width="20%" style="text-align: right !important;">$<?= number_format(floatval($price1[$i]), 2) ;?></td>
                                                                
                                                                <td width="20%" style="text-align: right !important;">$<?php
                                                                ...
                                                                <td width="20%" style="text-align: right !important;">$<?php echo number_format($total_amount1[$i],2); ?></td>
                                                            </tr>
                                                        <?php } 
                                                        $i++; 
                                                    } 
                                                    ...
                                                    foreach ($Array3 as $index => $person) {
                                                        ...
                                                        <tr class="item-table-border">
                                                            <td width="10%"><?php echo $person; ?>x</td>

                                                            <td>Labor</td>
                                                            
                                                            <td width="20%" style="text-align: right !important;">$ <?php echo $index; ?></td>
                                                            
                                                            <td width="20%" style="text-align: right !important;">$ 0.00</td>
                                                            
                                                            <td width="20%" style="text-align: right !important;">$ <?php echo number_format($laboramount,2); ?></td>
                                                        </tr>
                                                    <?php }
                                                } ?>
                                            </tbody>
                        ...
                        <tr>
                            ...
                            <td valign="top" width="50%" class="templateColumnContainer" style="margin-top: 15px !important;">
                                ...
                                <table class="payment-details-table" style="width: 100%">
                                    <tbody>
                                        <?php
                                            $late_grace_period = $msgData['getEmail1'][0]['late_grace_period'];
                                            $payment_date = date('Y-m-d', strtotime($msgData['getEmail1'][0]['recurring_pay_start_date']. ' + '.$late_grace_period.' days'));
                                            $late_fee_status = $msgData['getEmail1'][0]['late_fee_status'] ? $msgData['getEmail1'][0]['late_fee_status'] : 0;
                                            $late_fee = $msgData['getEmail1'][0]['late_fee'] ? $msgData['getEmail1'][0]['late_fee'] : ''; 
                                            $amount = $late_fee + $msgData['getEmail'][0]['amount'];
                                            if($late_fee_status > 0 && date('Y-m-d') > $payment_date) { 
                                        ?>
                                            <tr>
                                                <td width="50%" class="left">Sub Total</td>
                                                <td width="50%" style="text-align: right !important;">$ <?= number_format(($amount - $msgData['getEmail'][0]['late_fee'] - $msgData['getEmail'][0]['tax'] - $msgData['getEmail'][0]['other_charges']),2); ?></td>
                                            </tr>
                                            <tr>
                                                <td width="50%" class="left">Late Fee</td>
                                                <td width="50%" style="text-align: right !important;">$ <?= number_format($msgData['getEmail'][0]['late_fee'],2); ?></td>
                                            </tr>
                                            <?php //if($msgData['tax']!="" && $msgData['tax'] > 0) { ?>
                                                <tr>
                                                    <td width="50%" class="left">Total Tax</td>
                                                    <td width="50%" style="text-align: right !important;">$ <?= number_format($msgData['getEmail'][0]['tax'],2); ?></td>
                                                </tr>
                                            <?php //} ?>
                                            <?php if($msgData['other_charges']!="" && $msgData['getEmail'][0]['other_charges'] > 0) { ?>
                                                <tr>
                                                    <td width="50%" class="left"><?= $msgData['getEmail'][0]['otherChargesName'] ?></td>
                                                    <td width="50%" style="text-align: right !important;">$ <?= $msgData['getEmail'][0]['other_charges'] ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td width="50%" class="left">Sub Total</td>
                                                <td width="50%" style="text-align: right !important;">$ <?= number_format(($msgData['getEmail'][0]['amount'] - $msgData['getEmail'][0]['tax'] - $msgData['getEmail'][0]['other_charges']),2); ?></td>
                                            </tr>
                            ...
                            <td colspan="2" style="text-align: right !important;">
                                <div class="bottom-div twenty-div" style="display: inline-block;float: left;width: 100%;box-sizing: border-box;padding: 20px;">
                                    ...
                                    <div style="width: 100%;float: left;display: inline-block;margin-top: 30px;">
                                        ...
                                        <a href="<?= $msgData['getEmail'][0]['url'] ?>" class="custom-btn" style="color:white !important; background-color: #2273dc !important;  border-radius: 20px;text-transform: uppercase;padding: 10px 30px;font-size: 13px;text-decoration: none;float: right; -webkit-appearance: button;-moz-appearance: button;-ms-appearance: button;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;-moz-border-radius: 20px;-webkit-border-radius: 20px;-ms-border-radius: 20px;">CONTINUE TO PAYMENT</a>
