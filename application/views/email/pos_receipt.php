...
<html>
	...
	<body style="margin:0 auto;padding: 0;font-family: 'Open Sans', sans-serif;width: 100%;height: 100%;">
        <div class="main-box" style="background-image: linear-gradient(#<?= $msgData['getEmail1'][0]['color'] ?>,#<?= $msgData['getEmail1'][0]['color'] ?>);padding: 80px 0px 10px 0px !important;background-repeat: no-repeat;width: 100%;height: 100%;display: inline-block;background-size: 100% 190px;background-position: center top;">
			                    ...
			                    <table class="payment-details-table" style="width: 100%">
			                        <tbody>
		                                <tr>
		                                    ...
		                                    <td width="50%" style="text-align: right;">$ <?= number_format(($msgData['amount'] - $msgData['tax'] - $msgData['other_charges']), 2); ?></td>
		                                </tr>
			                        	<?php if(!empty($msgData['tax'])) { ?>
				                        	<tr>
			                                    <td width="50%" class="left">Total Tax</td>
			                                    <td width="50%" style="text-align: right;">$ <?= number_format($msgData['tax'],2) ?></td>
			                                </tr>
			                            <?php } ?>
			                            <?php if(!empty($msgData['other_charges'])) { ?>
				                        	<tr>
			                                    <td width="50%" class="left"><?= $msgData['otherChargesName'] ?></td>
			                                    <td width="50%" style="text-align: right;">$ <?= number_format($msgData['other_charges'],2) ?></td>
			                                </tr>
			                            <?php } ?>
			                        	<tr>
		                                ...
		                                <?php if(!empty($msgData['name'])) { ?>
				                        	<tr>
			                                    <td width="50%" class="left">Customer Name</td>
			                                    <td width="50%" style="text-align: right;"><?= $msgData['name'] ?></td>
			                                </tr>
			                            <?php } ?>
			                            <tr>
		                                    <td width="50%" class="left">Payment Status</td>
		                                    <td width="50%" style="text-align: right;"><?= $msgData['transaction_status'] ?></td>
		                                </tr>
			                        </tbody>
			                    </table>
			                </td>
