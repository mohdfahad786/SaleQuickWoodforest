                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="padding: 5px 1px;text-align: right !important;font-weight: 600;border-top: 1px solid rgba(236, 236, 236, 0.7);">$ <?php echo number_format($total_amount[$i],2); ?></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($msgData['getEmail'][0]['transaction_type'] != 'split'){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" style="text-align: right !important;"><?= (!empty($msgData['getEmail'][0]['reference']) ? $msgData['getEmail'][0]['reference'] : 'N/A'); ?></td>
                                            </tr>
                                            <tr>
