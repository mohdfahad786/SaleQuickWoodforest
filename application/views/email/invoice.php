                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td width="50%" style="text-align: right !important;">$ <?= number_format(($amount - $msgData['late_fee'] - $msgData['tax'] - $msgData['other_charges']),2); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <?php if($msgData['other_charges']!="" && $msgData['other_charges'] > 0) { ?>
                                                <tr>
                                                    ...
                                                    <td width="50%" style="text-align: right !important;">$ <?= $msgData['other_charges'] ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td width="50%" class="left">Sub Total</td>
                                                <td width="50%" style="text-align: right !important;">$ <?= number_format(($msgData['amount'] - $msgData['tax'] - $msgData['other_charges']),2); ?></td>
                                            </tr>
                                            <?php //if($msgData['tax']!="" && $msgData['tax'] > 0) { ?>
                                                <tr>
                                                    <td width="50%" class="left">Total Tax</td>
