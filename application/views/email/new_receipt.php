...
<html>
    ...
    <body style="margin:0 auto;padding: 0;font-family: 'Open Sans', sans-serif;width: 100%;height: 100%;position: relative;">
        ...
        <div class="main-box" style="background-image: -webkit-linear-gradient(#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>,#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>);background-image: -moz-linear-gradient(#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>,#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>);background-image: linear-gradient(#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>,#<?= !empty($msgData['getEmail1'][0]['color']) ? $msgData['getEmail1'][0]['color'] : '2273dc'; ?>);padding: 80px 0px 10px 0px;background-repeat: no-repeat;width: 100%;height: 100%;display: inline-block;background-size: 100% 190px;background-position: center top;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" id="templateColumns" style="margin: auto;width: 100%;">
                        ...
                        <tr>
                            <td valign="top" width="50%" class="templateColumnContainer">
                                <?php if($msgData['getEmail1'][0]['logo']) { ?>
                                    ...
                                    <tbody>
                                                        ...
                                                        <?php if($msgData['getEmail'][0]['transaction_type'] != 'split'){ ?>
                                                            <tr>
                                                                ...
                                                                <td width="50%" style="text-align: right !important;">
                                                                    ...
                                                                    // settype($subttl2,float);
                                                                    $tip=$msgData['getEmail'][0]['tip_amount']?$msgData['getEmail'][0]['tip_amount']:0;
                                                                    echo '$'.number_format(($subttl1 - $subttl2 - $tip - $late_fee - $o_charges),2);
                                                                    ?>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                        ...
                                        <?php //if($msgData['tax']!="" && $msgData['tax'] > 0) { ?>
                                            <tr>
                                                ...
                                                <td width="50%" style="text-align: right !important;">$<?php echo number_format($msgData['tax'], 2); ?></td>
                                            </tr>
                                        <?php //} ?>
                                        <?php if($msgData['getEmail'][0]['other_charges']!="" && $msgData['getEmail'][0]['other_charges'] > 0) { ?>
                                            <tr>
                                                <td width="50%"><?php echo $msgData['getEmail'][0]['otherChargesName']; ?></td> 
                                                <td width="50%" style="text-align: right !important;">$<?php echo number_format($msgData['getEmail'][0]['other_charges'],2); ?></td>
                                            </tr>
                                        <?php } ?>
                                        <tr>
