                    ...
                    <table style="max-width: 351px;width: 100%;font-size: 14px;clear: both;margin: 0 auto" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="padding: 5px 1px;border-top: 1px solid rgba(236, 236, 236, 0.7);text-align: right;font-weight: 600;">$<?= $msgData['amount'] ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px 1px;border-top: 1px solid rgba(236, 236, 236, 0.7);text-align: right;font-weight: 600;"><?= $msgData['getEmail'][0]['tip_amount'] ?></td>
                            </tr>
                            <tr>
