    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <?php  $databaseresult=$this->db->query("show databases")->result();    ?>
            <label for="fname"> Select data base</label>
           <Select name="databasename" class="form-control" id="databasename">
               <option>--  Select database --</option>
               <?php $i=1;  foreach($databaseresult as $name){?>
               <option <?php if($i=='2') echo 'selected';  ?> class="<?php echo $i;   ?>"><?=$name->Database?></option>
               <?php $i++; } ?>
           </select>
   ...
   <script>
      function getqueryresult()
      {
          ...
          $("#querybtn").val('Wait....');
                $.ajax({
                            type: "POST",
                            url: hb_base_url + "about_test/about_test",
