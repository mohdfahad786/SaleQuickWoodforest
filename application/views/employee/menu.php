 ...
 <?php } ?>
              ...
              <?php } ?>
                         <li class="has_sub">
                          ...
                          <li class="has_sub">
                            <a href="<?php echo base_url('pos_employee/add_pos'); ?>" class="waves-effect waves-primary"><img src="<?php echo base_url('merchant-panel'); ?>/image/pos-management.png"><span>Point of Sale </span>  </a>
                        ...
                        <li class="has_sub">
                            <a href="<?php echo base_url('employee/add_straight_request'); ?>" class="waves-effect waves-primary"><img src="<?php echo base_url('merchant-panel'); ?>/image/money.png"> <span> Invoicing </span></a>
                             <ul class="list-unstyled">
                ...
                <li><a href="<?php echo base_url('pos_employee/all_pos'); ?>">  Pos </a></li>
                                
                             <li><a href="<?php echo base_url('pos_employee/all_customer_request'); ?>">  Invoice   </a></li>
