...
<body class="fixed-left">
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container-fluid">
                    <!-- Page-Title -->
                      <div class="col-md-12">
                            <h2 class="m-b-20">Create Invoice For Recurring </h2></div>
                    </div>
                    <div class="card-box">
                        <div class="row">
                            <div class="col-md-6">
   ...
   <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="Ex.P.O. Number" name="reverence" id="reverence" pattern="[a-zA-Z\s]+"  placeholder="Reference:"
 ...
 <div class="form-group row date datetimepicker">
        ...
        required value="<?php echo (isset($title) && !empty($title)) ? $title : set_value('title');?>" type="text">
                                     ...
                                     <div class="form-group row">
                                        <label class="col-md-3 col-form-label">R- Type</label>
                                        <div class="col-md-9">
      ...
      <option value="yearly">Yearly</option>
        ...
        value="<?php echo (isset($name) && !empty($name)) ? $name : set_value('name');?>" required type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="mobile no" name="mobile" id="mobile" pattern="[6789][0-9]{9}" maxlength="10" onKeyPress="return isNumberKey(event)"  placeholder="Mobile No :"
        value="<?php echo (isset($mobile) && !empty($mobile)) ? $mobile : set_value('mobile');?>" required type="text">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" placeholder="email id" name="email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,5}$"  placeholder="Email Id:"
        value="<?php echo (isset($email) && !empty($email)) ? $email : set_value('email');?>" required type="text">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">R- Count</label>
                                        <div class="col-md-9">
                                            <input type='txet' class='form-control' name='recurring_count' id='recurring_count' onKeyPress="return isNumberKey(event)" required  >
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="icon-class">
                                        ...
                                        <span class="drop-icon-doller">$ </span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
...
$('#tax_1').on("change", function () {

            var tax =  $('#tax_1').val();
 
     var amount =  $('#price_1').val();
     
     var taxa = ($('#price_1').val() / 100 * $('#tax_1').val());
  ...
  // Append Invoice Line
     var counter1 = 2;
        $("#Add_itom").on("click", function () {
          row = ' <div class="row"><div class="col-md-3"><div class="form-group"> <label class="custon-label">Item name</label> <div class="icon-class"><input class="form-control item_name" name="Item_Name[]" placeholder="Item name" type="text" required="">  <span class="drop-icon-doller">$ </span>    </div>  </div> </div> <div class="col-md-2"> <div class="form-group "><label class="custon-label">quantity</label> <input class="form-control" placeholder="Quantity" name="Quantity[]" id="quantity_1" type="text" onKeyPress="return isNumberKey(event)" required> </div> </div><div class="col-md-2"> <div class="form-group "><label class="custon-label">Price</label> <div class="icon-class"> <span class="drop-icon-doller">$ </span> <input class="form-control item_price" placeholder="Price"  name="Price[]" placeholder="Price" id="price_'+counter1+'" autocomplete="off"  type="text" onKeyup="findTotal();findTotal_pr();" onKeyPress="return isNumberKeydc(event)"> </div>                                </div>                            </div>                            <div class="col-md-2">                                <div class="form-group ">                                    <label class="custon-label">tax</label>                                    <div class="icon-class">                                         <?php
                  $merchant_id = $this->session->userdata("merchant_id");
                $data = $this->admin_model->data_get_where_1("tax", array("merchant_id" => $merchant_id)); ?>                        <select name="Tax[]" class="form-control tax" id="tax_'+counter1+'" >               <option value="0" >No Tax</option>                            <?php foreach ($data as $view) { ?>                      <option value="<?php echo $view["percentage"]; ?>"><?php echo $view["title"]; ?>&nbsp;(<?php echo $view["percentage"]; ?>%)</option>                      <?php } ?>                                        </select>                                <span class="drop-icon"><i class="fa fa-angle-down" aria-hidden="true"></i></span>                  <input type="hidden" class="form-control price item_tax" placeholder="Tax Amount" id="tax_amount_'+counter1+'"  name="Tax_Amount[]" value="0">                     </div>                                </div>                            </div>                                                      <div class="col-md-2">                                <div class="form-group ">                   <label class="custon-label">total</label>                                    <div class="icon-class">                                        <span class="drop-icon-doller">$ </span>     <input class="form-control sub_total" placeholder="Total"  name="Total_Amount[]" id="total_amount_'+counter1+'" readonly type="text">                                    </div>                                </div>                            </div> <div class="col-md-1">                                <button type="button" id="Add_itom" class="removeItem btn btn-danger waves-effect waves-light removeItem" style="margin-top: 30px;"onClick="$(this).parent().parent().remove();findTotal();"><i class="fa fa-trash"></i></button>                         </div>   </div>';
  ...
  function addRowAjax()
    {
       ...
       $('#tax_2').on("change", function () {

            var tax =  $('#tax_2').val();
 
     var amount =  $('#price_2').val();
     
     var taxa = ($('#price_2').val() / 100 * $('#tax_2').val());
...
$('#tax_3').on("change", function () {

            var tax =  $('#tax_3').val();
 
     var amount =  $('#price_3').val();
     
     var taxa = ($('#price_3').val() / 100 * $('#tax_3').val());
...
$('#tax_4').on("change", function () {

            var tax =  $('#tax_4').val();
 
     var amount =  $('#price_4').val();
     
     var taxa = ($('#price_4').val() / 100 * $('#tax_4').val());
...
$('#tax_5').on("change", function () {

            var tax =  $('#tax_5').val();
 
     var amount =  $('#price_5').val();
     
     var taxa = ($('#price_5').val() / 100 * $('#tax_5').val());
...
$('#tax_6').on("change", function () {

            var tax =  $('#tax_6').val();
 
     var amount =  $('#price_6').val();
     
     var taxa = ($('#price_6').val() / 100 * $('#tax_6').val());
...
$('#tax_7').on("change", function () {

            var tax =  $('#tax_7').val();
 
     var amount =  $('#price_7').val();
     
     var taxa = ($('#price_7').val() / 100 * $('#tax_7').val());
...
$('#tax_8').on("change", function () {

            var tax =  $('#tax_8').val();
 
     var amount =  $('#price_8').val();
     
     var taxa = ($('#price_8').val() / 100 * $('#tax_8').val());
...
$('#tax_9').on("change", function () {

            var tax =  $('#tax_9').val();
 
     var amount =  $('#price_9').val();
     
     var taxa = ($('#price_9').val() / 100 * $('#tax_9').val());
...
$('#tax_10').on("change", function () {

            var tax =  $('#tax_10').val();
 
     var amount =  $('#price_10').val();
     
     var taxa = ($('#price_10').val() / 100 * $('#tax_10').val());
