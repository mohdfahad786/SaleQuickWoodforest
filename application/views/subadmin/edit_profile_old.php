...
if(isset($msg))
echo "<h4> $msg</h4>";
echo form_open_multipart('profile/'.$loc, array('id' => "my_form"));
                    ...
                    <div class="card-box">
                        <div class="row">
                           ...
                           <div class="form-group col-md-12">
                            <?php 
                            if($mypic!=''){
                            echo "<img width = \"100\"; height= \"100\" src=".$upload_loc."/".$mypic.">";
                            }
                            ?>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-11 pad-l-60">
                                           <input type="password" class="form-control" name="cpsw" id="cpsw"  >
                                              ...
                                              <input type="hidden" class="form-control" name="psw" id="psw"  value="<?php echo (isset($psw) && !empty($psw)) ? $psw : set_value('psw');?>">
                                    </div>
                                </div>
                            </div>
