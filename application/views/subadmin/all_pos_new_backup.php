...
<div class="col-md-12">
  ...
  <div class="card-box">
    <form method="post" action="<?php echo base_url('admin/all_pos');?>" >
                        <div class="row">
...
<td> <?php echo $a_data['card_type'] ?></td>
<td>
...
if($a_data['status']=='pending'){
 echo '<a href="https://salequick.com/pos_reciept/'.$a_data['payment_id'].'/'.$a_data['merchant_id'].'" target="_blank">
