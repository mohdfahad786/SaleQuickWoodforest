        ...
        ?> 
          ...
          <div class="col-12">
            <div class="form-group">
              <input type="email" name="admin_email" id="admin_email" class="form-control" placeholder="Enter Email" required="">
            </div>
          </div>
          <div class="col-12">
            <div class="form-group">
              <button type="submit" id="btn_login" name="btn_login" class="btn btn-first" value="Reset">Reset</button>
            </div> 
          </div>
          <div class="col-12">
