    ...
    <div class="wrapper">
      ...
      <header class="main-header">
       ...
       <?php
        ...
        <?php   } else { ?>
	 <a href="#" class="logo"><b>SubAdmin</b></a>
             ...
             <?php   $image = $this->session->userdata('image'); ?>
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo base_url("logo/".$image.""); ?>" class="user-image" alt="<?php echo  $session_id = $this->session->userdata('name'); ?>"/>
                  <span class="hidden-xs"><?php echo  $session_id = $this->session->userdata('name'); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
             <img src="<?php echo base_url("logo/".$image.""); ?>" class="img-circle" alt="<?php echo  $session_id = $this->session->userdata('name'); ?>"/>
                    <p>
                     <p><?php echo  $session_id = $this->session->userdata('name'); ?></p>
