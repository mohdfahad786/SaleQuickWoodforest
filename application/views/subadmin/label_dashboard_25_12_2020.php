                ...
                <div class="col-md-3 col-sm-6 col-6 equel-grid summary-grid-padding">
                        ...
                        <div class="grid-body text-gray top_grid_effect">
                            <div class="d-flex justify-content-between">
                                <div class="summary-grid-text-section">
                                    <h1 class="newtotalorders head-count-val">$ <?php echo $getDashboardData[0]['TotalOrders'] + $getDashboardData[0]['TotalPosorder'];?>.00</h1>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <p class="summary-grid-status">Transaction </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-10">
                                    <small class="summary-grid-text">All Transactions For The Day</small>
                                </div>
                    ...
                    <div class="grid grid-summary">
                        <div class="grid-body text-gray top_grid_effect">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <p class="summary-grid-status">Accounts</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-10">
                                    <small class="summary-grid-text"> Approved For The Month</small>
                                </div>
                                <div class="col-2" style="margin-left: -5px !important;">
                ...
                <div class="col-md-3 col-sm-6 col-6 equel-grid summary-grid-padding">
                    <div class="grid grid-summary">
                        <div class="grid-body text-gray top_grid_effect">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <small class="summary-grid-text">Inactive For The Month</small>
                                </div>
                                <div class="col-2" style="margin-left: -5px !important;">
                ...
                <div class="col-md-3 col-6 col-sm-6 equel-grid">
                    <div class="grid grid-summary">
                        <div class="grid-body text-gray top_grid_effect">
                            <div class="d-flex justify-content-between">
                                <div class="summary-grid-text-section">
                                    <h1 class="TotalLate head-count-val" style="color: #000 !important;"><?php echo $widgets_data['TotalLate']; ?></h1>
                                </div>
                                <div class="summary-grid-img-section">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <small class="summary-grid-text">Cancel For The Month</small>
                                </div>
                                <div class="col-2" style="margin-left: -5px !important;">
