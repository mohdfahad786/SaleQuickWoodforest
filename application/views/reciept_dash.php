                                ...
                                <div class="display-avatar" style="padding: 0px !important;">
                                    ...
                                    <?php } else { ?>
                                        <div class="owner-name" style="font-size: 50px !important;">
                                            <?php if($itemm[0]['business_dba_name']) echo ucfirst(substr($itemm[0]['business_dba_name'],0,1)); ?>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            for($i=0; $i<$itemLength; $i++) { 
                                                ...
                                                <tr class="item-table-border">
                                                    <td><?=$item_name[$i]; ?></td>
                                                    <td width="20%" style="text-align: right;">$ <?php echo number_format($total_amount[$i],2); ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                ...
                                <div class="row" style="margin-bottom: 20px !important;">
                                    <div class="col-12">
                                        <?php if(!empty($sign)) {
                                            ...
                                            <img src="<?=base_url();?>uploads/sign/<?php echo $file; ?>" class="signature-size"/>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="row">
                                    ...
                                    <table class="payment-details-table" style="width: 100%">
                                        <tbody>
                                            <?php if($getEmail[0]['other_charges']!="" && $getEmail[0]['other_charges'] > 0) { ?>
                                                <tr>
                                                    <td width="50%" class="left"><?php echo !empty($getEmail[0]['otherChargesName']) ? $getEmail[0]['otherChargesName'] : 'Other Charges'; ?></td>
                                                    <td width="50%" style="text-align: right;">$<?php echo $getEmail[0]['other_charges']; ?></td>
                                                </tr>
                                            <?php } ?>
                                            <?php if($tax!="" && $tax > 0) { ?>
                                                <tr>
                                                    <td width="50%" class="left">Tax</td>
                                                    <td width="50%" style="text-align: right;">$<?php echo (isset($tax))? $tax : "0.00"; ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" style="text-align: right;"><?php if(!empty($transaction_id)){echo $transaction_id;} else { ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php } ?></td>
                                            </tr>
                                            <?php if(!empty($getEmail[0]['reference'])) { ?>
                                                <tr>
                                                    <td width="50%" class="left">Reference</td>
                                                    <td width="50%" style="text-align: right;"><?php echo $getEmail[0]['reference']; ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                            ...
                                            <?php if($name) { ?>
                                                <tr>
                                                    ...
                                                    <td width="50%" style="text-align: right;"><?php echo ucfirst($name); ?></td>
                                                </tr>
                                            <?php } ?>
                                            <?php if(!empty($name_card)){ ?> 
                                                <tr>
                                                    <td width="50%" class="left">Name On Card</td>
                                                    <td width="50%" style="text-align: right;"><?php if(!empty($name_card)){echo ucfirst($name_card);} else { ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php } ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td width="50%" class="left">Payment Status</td>
                                                <td width="50%" style="text-align: right;text-transform: uppercase;color:#4a90e2;margin-top:0;font-size: 14px;font-weight: 600;"><?php echo $message; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
