...
class Acceptcard_model extends CI_Model {
	public function __construct() {
      ...
      public function updateInvoiceAndToken($token,$merchant_id,$invoice_no)
      {
      ...
      public function updateRecurringCount($invoice_no)
      {
        $q1="update customer_payment_request set recurring_count_paid=recurring_count_paid+1,recurring_count_remain=recurring_count_remain-1 where invoice_no='".$invoice_no."'";
        $this->db->query($q1);
        //echo $this->db->last_query();die; 
      }
