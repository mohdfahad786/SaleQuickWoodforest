...
class Recurring_serverside_model extends CI_Model {
	...
	public function count_filtered() {
		...
		$query_count_filter = $this->db->query("SELECT invoice_no FROM customer_payment_request WHERE payment_type = 'recurring' AND date_c >= '".$start_date. "' AND date_c <= '".$end_date. "' AND merchant_id = ".$merchant_id. $where.$where_search);
