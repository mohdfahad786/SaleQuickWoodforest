		...
		if ($merchant_status == 'active') {    
			...
			if(isset($_POST['submit']) && $id!="")
			{
				...
				if ($this->form_validation->run() == FALSE) {
					...
					redirect(base_url('merchant/edit_customer_request/'.$id)); 
										  ...
										  // echo $mn;  die(); 
										   ...
										   $data2['item_detail'] = $item_Detail_1;  
											...
											$header = "From: ".$getDashboardData_m[0]['business_dba_name']."<info@salequick.com >\r\n" .
											  ...
											  $this->session->set_flashdata('success', '<h3> Invoice  : <span style="color:#f5a623; ">'.$invoice_no.'</span> Updated..</h3>'); 
											...
											$paymentcard=$token_data['token'];
											  ...
											  if($paymentcard)   //   if card are save 
											  {
												...
												else
												{
													...
													$this->session->set_flashdata('error', '<h3> Invoice  : <span style="color:#f5a623; ">'.$invoice_no.'</span> &nbsp;&nbsp;'.$id.'..</h3>'); 
													redirect(base_url('pos/all_customer_request_recurring'));
												}
            ...
            {    
                ...
                $data['get_recurring_invoice']=$this->admin_model->select_request_id('customer_payment_request',$id); 
