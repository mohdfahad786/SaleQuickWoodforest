...
// 			$total_amount = $package_data_card_total[0]['amount']+$package_data_total_count_invoice[0]['amount']+$package_data_total_count_invoice_re[0]['amount'];
...
// 			}
// 		}
		// echo $data['package_amount'].' , 123';die;
		$this->session->unset_userdata('mymsg');
