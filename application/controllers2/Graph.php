...
(SELECT sum(amount) as Totaljan from ( SELECT month,amount from customer_payment_request where merchant_id = '" . $merchant_id . "' and month = '01' and year = '" . $today2 . "' and status='confirm'   union all SELECT month,amount from recurring_payment where merchant_id = '" . $merchant_id . "' and month = '01' and year = '" . $today2 . "' and status='confirm' union all SELECT month,amount from pos where merchant_id = '" . $merchant_id . "' and month = '01' and year = '" . $today2 . "' and status='confirm' )x group by month ) as Totaljan   ,
	...
	(SELECT sum(`amount`-`p_ref_amount`) as Totalfeb from ( SELECT month,amount,p_ref_amount from customer_payment_request where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $today2 . "' and (status='confirm' or partial_refund=1)   union all SELECT month,amount,p_ref_amount from recurring_payment where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $today2 . "' and (status='confirm' or partial_refund=1) union all SELECT month,amount,p_ref_amount from pos where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $today2 . "' and (status='confirm' or partial_refund=1) )x group by month ) as Totalfeb   ,
...
(SELECT sum(`amount`-`p_ref_amount`) as Totalbfeb from ( SELECT month,amount,p_ref_amount from customer_payment_request where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $last_year . "' and (status='confirm' or partial_refund=1)   union all SELECT month,amount,p_ref_amount from recurring_payment where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $last_year . "' and (status='confirm' or partial_refund=1) union all SELECT month,amount,p_ref_amount from pos where merchant_id = '" . $merchant_id . "' and month = '02' and year = '" . $last_year . "' and (status='confirm' or partial_refund=1) ) x group by month ) as Totalbfeb   ,
