...
<body>
    ...
    <div class="invoice-wrapper">
       <div class="irm-header-inner">
            <form class="cardPaymentFormWrapper row" action="<?= base_url('payment_cnp_invoicing/'.$_POST['bct_id1'].'/'.$_POST['bct_id2']); ?>" method="post">
                <!-- <div class="col-xs-6"> -->
             ...
             //alert("its ok");   exit;  
                   ...
                   if(is_signature=='1')
                   {
                    ...
                    //call ajax ---------------------------------
                      ...
                      $.ajax({
                        type: "POST",
                        url: "<?php echo base_url()?>signup/payment_cnp_invoicing",
