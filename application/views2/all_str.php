...
<h1> View All Straight  Payment Request </h1>
...
<a href="<?php echo site_url('merchant/add_straight_request'); ?>" class="btn btn-primary" title="Click for Add New"><i class="fa fa-plus"></i> Send New Payment Request </a>
...
if($a_data['status']=='pending'){
 ...
 echo '<span class="label label-danger"> '.$a_data['status'].'  </span>';
...
echo '<span class="label label-success"> '.$a_data['status'] .' </span>';
