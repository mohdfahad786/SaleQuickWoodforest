    ...
    <ul class="navigation-menu">
            ...
            <li>
                ...
                <ul class="collapse navigation-submenu" id="dashboard">
                        ...
                        <li>
                            <a href="<?=base_url('agent/dashboard')?>">Dashboard</a>
                        </li>
...
<li>
            ...
            <a href="<?=base_url('agent/all_pos')?>">Instore & Mobile </a>

          </li>
               
                             <li>

            <a href="<?=base_url('agent/all_customer_request')?>">  Invoice   </a>

          </li>
                     <li>

            <a href="<?=base_url('agent/all_customer_request_recurring')?>">  Recurring   </a>

          </li>
                   <!--  <li>

            <a href="<?=base_url('agent/all_recurrig_request')?>">  Recurring Request   </a>
        ...
        <li>
            ...
            <a href="<?php echo  base_url('agent/edit_profile');?>"> Reseller detail </a>

          </li>

          <li>

            <a href="<?php echo base_url('agent/logout'); ?>">Log Out 
