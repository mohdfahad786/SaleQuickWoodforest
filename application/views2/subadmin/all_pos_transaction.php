      ...
      <div class="row sales_date_range">
        <div class="col-12 custom-form">
          <div class="card content-card">
            <form class="row" method="post" action="<?php echo base_url('subadmin/all_pos'); ?>">
              <div class="col">
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach ($mem as $a_data) {
                        ...
                        $pos_transaction_id=$a_data['transaction_id'];
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        echo '<span class="pos_Status_c"> Confirm </span>';
                      ...
                      <td> <?php echo  date('d-F-Y', strtotime($a_data['date'])); ?></td>
                      <td>
                            <div class="dropdown dt-vw-del-dpdwn">
                               ...
                               <?php if ($a_data['status'] == 'pending') { ?> 
                                <a  class="dropdown-item" target="_blank" href="<?php echo base_url($receipt_type.'/'.$a_data['invoice_no'].'/'.$a_data['merchant_id']); ?>"><i class="fa fa-eye"></i> Invoice</a>
                               <?php } else if($a_data['status'] == 'confirm' || $a_data['status'] == 'Refund' ||  $a_data['status'] == 'Chargeback_Confirm' ){ ?>
                                <a class="dropdown-item" target="_blank" href="<?php echo base_url($receipt_type.'/'.$a_data['invoice_no'].'/'.$a_data['merchant_id']); ?>"><i class="fa fa-eye"></i> Receipt</a>
                               <?php } ?>
                               <a href="#" data-toggle="modal" data-target="#view-modal" data-id="<?php echo $a_data['id']; ?>" id="getUser" class="dropdown-item"><i class="ti-eye"></i> Detail</a>
                                </div>
                              </div>
                          </td>
                    </tr>
...
$(document).ready(function(){
  ...
  $(document).on('click', '#getUser', function(e){
   ...
   $.ajax({
      url: "<?php echo base_url('subadmin/search_record_column_pos'); ?>",
      type: 'POST',
      data: 'id='+uid,
      dataType: 'html'
   })
