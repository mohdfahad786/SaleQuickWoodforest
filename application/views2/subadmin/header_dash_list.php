...
<html lang="en">
    <head>
        ...
        <link href="https://salequick.com/new_assets/css/waves.css" rel="stylesheet" type="text/css">
        ...
        <link href="https://salequick.com/new_assets/css/daterangepicker.css" rel="stylesheet"/>

        <link rel="stylesheet" type="text/css" href="https://salequick.com/new_assets/css/style.css">
        
        <script src="https://salequick.com/new_assets/js/jquery.min.js"></script>
        <script src="https://salequick.com/assets/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="https://salequick.com/merchant-panel/plugins/multiselect/js/jquery.multi-select.js"></script>
        
        <script src="https://salequick.com/new_assets/js/app.min1.js"></script>
        <script src="https://salequick.com/new_assets/js/app.min2.js"></script>

        <script src="https://salequick.com/new_assets/js/dashboard_js/apexcharts.min.js"></script>
        <script src="https://salequick.com/new_assets/js/dashboard_js/Chart.min.js"></script>
        <script src="https://salequick.com/new_assets/js/dashboard_js/chartjs.addon.js"></script>
