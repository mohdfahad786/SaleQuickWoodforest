 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
//define ('K_PATH_IMAGES', 'http://localhost:8080/salequick/logo/');
 ...
 * Page format.
 */
define ('PDF_PAGE_FORMAT', 'A4 LANDSCAPE');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Salequick Report');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Salequick\nReport");
