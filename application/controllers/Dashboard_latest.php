...
class Dashboard extends CI_Controller {
	...
	public function index() {
    	...
    	if($month=='01' ){
         	$amount = $this->db->query("SELECT sum(amount) as Totaljan from ( SELECT month,amount from customer_payment_request where  month = '01' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '01' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totaljanf from ( SELECT month,amount from customer_payment_request where  month = '01' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '01' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

         	$getfee = $fee->result_array();


         	$tax = $this->db->query("SELECT sum(tax) as Totaljantax from ( SELECT month,tax from customer_payment_request where   month = '01' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '01' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

           	$gettax = $tax->result_array();

           
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totaljan='".$getamount[0]['Totaljan']."' ,Totaljanf='".$getfee[0]['Totaljanf']."',Totaljantax='".$gettax[0]['Totaljantax']."'  ");

 		}

 		 		 else if($month=='02' ){
               	$amount = $this->db->query("SELECT sum(amount) as Totalfeb from ( SELECT month,amount from customer_payment_request where  month = '02' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '02' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totalfebf from ( SELECT month,amount from customer_payment_request where  month = '02' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '02' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

         	$getfee = $fee->result_array();


         	$tax = $this->db->query("SELECT sum(tax) as Totalfebtax from ( SELECT month,tax from customer_payment_request where   month = '02' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '02' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

           	$gettax = $tax->result_array();

           
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totalfeb='".$getamount[0]['Totalfeb']."' ,Totalfebf='".$getfee[0]['Totalfebf']."',Totalfebtax='".$gettax[0]['Totalfebtax']."'  ");

          // echo $this->db->last_query();die;
 }

    	else if($month=='07' ){
         	$amount = $this->db->query("SELECT sum(amount) as Totaljuly from ( SELECT month,amount from customer_payment_request where  month = '07' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '07' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totaljulyf from ( SELECT month,amount from customer_payment_request where  month = '07' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '07' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

         	$getfee = $fee->result_array();

           	$tax = $this->db->query("SELECT sum(tax) as Totaljulytax from ( SELECT month,tax from customer_payment_request where   month = '07' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '07' and year = '" . $today2 . "' and status='confirm' )x group by month  ");

           	$gettax = $tax->result_array();
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totaljuly='".$getamount[0]['Totaljuly']."' ,Totaljulyf='".$getfee[0]['Totaljulyf']."',Totaljulytax='".$gettax[0]['Totaljulytax']."'  ");

 		} else if($month=='08') {
         	$amount = $this->db->query("SELECT sum(amount) as Totalaugust from ( SELECT month,amount from customer_payment_request where  month = '08' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '08' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totalaugustf from ( SELECT month,amount from customer_payment_request where  month = '08' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '08' and year = '" . $today2 . "' and status='confirm' )x group by month ");

         	$getfee = $fee->result_array();

           	$tax = $this->db->query("SELECT sum(tax) as Totalaugusttax from ( SELECT month,tax from customer_payment_request where  month = '08' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '08' and year = '" . $today2 . "' and status='confirm' )x group by month");

           	$gettax = $tax->result_array();
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totalaugust='".$getamount[0]['Totalaugust']."' ,Totalaugustf='".$getfee[0]['Totalaugustf']."',Totalaugusttax='".$gettax[0]['Totalaugusttax']."'   ");

		} else if($month=='09') {
         	$amount = $this->db->query("SELECT sum(amount) as Totalsep from ( SELECT month,amount from customer_payment_request where  month = '09' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '09' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totalsepf from ( SELECT month,amount from customer_payment_request where month = '09' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '09' and year = '" . $today2 . "' and status='confirm' )x group by month ");

         	$getfee = $fee->result_array();

           	$tax = $this->db->query("SELECT sum(tax) as Totalseptax from ( SELECT month,tax from customer_payment_request where  month = '09' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '09' and year = '" . $today2 . "' and status='confirm' )x group by month");

           	$gettax = $tax->result_array();
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totalsep='".$getamount[0]['Totalsep']."' ,Totalsepf='".$getfee[0]['Totalsepf']."',Totalseptax='".$gettax[0]['Totalseptax']."'  ");

		} else if($month=='10' ) {
         	$amount = $this->db->query("SELECT sum(amount) as Totaloct from ( SELECT month,amount from customer_payment_request where  month = '10' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '10' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totaloctf from ( SELECT month,amount from customer_payment_request where  month = '10' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '10' and year = '" . $today2 . "' and status='confirm' )x group by month ");

         	$getfee = $fee->result_array();

           	$tax = $this->db->query("SELECT sum(tax) as Totalocttax from ( SELECT month,tax from customer_payment_request where  month = '10' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '10' and year = '" . $today2 . "' and status='confirm' )x group by month");

           	$gettax = $tax->result_array();
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totaloct='".$getamount[0]['Totaloct']."' ,Totaloctf='".$getfee[0]['Totaloctf']."',Totalocttax='".$gettax[0]['Totalocttax']."'  ");

		} else if($month=='11') {
         	$amount = $this->db->query("SELECT sum(amount) as Totalnov from ( SELECT month,amount from customer_payment_request where  month = '11' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '11' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      		$getamount = $amount->result_array();

          	$fee = $this->db->query("SELECT avg(amount) as Totalnovf from ( SELECT month,amount from customer_payment_request where  month = '11' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '11' and year = '" . $today2 . "' and status='confirm' )x group by month ");

         	$getfee = $fee->result_array();

           	$tax = $this->db->query("SELECT sum(tax) as Totalnovtax from ( SELECT month,tax from customer_payment_request where  month = '11' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '11' and year = '" . $today2 . "' and status='confirm' )x group by month");

           	$gettax = $tax->result_array();
          
           	$amount = $this->db->query("UPDATE admin_year_graph SET Totalnov='".$getamount[0]['Totalnov']."' ,Totalnovf='".$getfee[0]['Totalnovf']."',Totalnovtax='".$gettax[0]['Totalnovtax']."'  ");
		}

		else if($month=='12'){
	

         $amount = $this->db->query("SELECT sum(amount) as Totaldec from ( SELECT month,amount from customer_payment_request where  month = '12' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '12' and year = '" . $today2 . "' and status='confirm' )x group by month  ");
          
      $getamount = $amount->result_array();

          $fee = $this->db->query("SELECT avg(amount) as Totaldecf from ( SELECT month,amount from customer_payment_request where  month = '12' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,amount from pos where  month = '12' and year = '" . $today2 . "' and status='confirm' )x group by month ");

         $getfee = $fee->result_array();

           $tax = $this->db->query("SELECT sum(tax) as Totaldectax from ( SELECT month,tax from customer_payment_request where  month = '12' and year = '" . $today2 . "' and status='confirm'    union all SELECT month,tax from pos where  month = '12' and year = '" . $today2 . "' and status='confirm' )x group by month");

           $gettax = $tax->result_array();
          
           $amount = $this->db->query("UPDATE admin_year_graph SET Totaldec='".$getamount[0]['Totaldec']."' ,Totaldecf='".$getfee[0]['Totaldecf']."',Totaldectax='".$gettax[0]['Totaldectax']."'  ");
	...
	function getAllMerchants() {
        ...
        foreach($memData as $member) {
         ...
         //    if($member->status == "confirm") {
            ...
            if(($_SESSION['id'] == 1) || ($_SESSION['id'] == 2) || ($_SESSION['id'] == 4)) {
