...
class Inventory_report_ajax extends CI_Controller {
	...
	public function pdf_child_report() {
		...
		if($merchant_id == '543') {
        	if( ($start_date >= '2022-06-01') && ($end_date <= '2022-06-15') ) {
        		$textcolors .= '<tr >
					<td  style="border-left: 1px solid grey; border-bottom:1px solid grey;font-size: 10px;" width="30%" >Ladies Full Zip</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey;font-size: 10px;" width="10%">5</td>
					<td style="border-bottom:1px solid grey;font-size: 10px;"width="10%">0</td>
					<td style=" border-bottom:1px solid grey;font-size: 10px;" width="10%">$ 451.60</td>
					<td style="border-bottom:1px solid grey;font-size: 10px;" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey;font-size: 10px;" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey;font-size: 10px;" width="10%">$ 451.60</td>
				</tr>';

				$textcolors .= '<tr>
				    <td style="border-left: 1px solid grey; border-bottom:1px solid grey;" width="30%">&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Grey M</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey" width="10%">2</td>
					<td style="border-bottom:1px solid grey" width="10%">0</td>
					<td style=" border-bottom:1px solid grey" width="10%">$ 88.70</td>
					<td style="border-bottom:1px solid grey" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey" width="10%">$ 88.70</td>
				</tr>';

				$textcolors .= '<tr>
				    <td style="border-left: 1px solid grey; border-bottom:1px solid grey;" width="30%">&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Black 2XL</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey" width="10%">2</td>
					<td style="border-bottom:1px solid grey" width="10%">0</td>
					<td style=" border-bottom:1px solid grey" width="10%">$ 92.30</td>
					<td style="border-bottom:1px solid grey" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey" width="10%">$ 92.30</td>
				</tr>';

				$textcolors .= '<tr>
				    <td style="border-left: 1px solid grey; border-bottom:1px solid grey;" width="30%">&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Grey 2XL</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey" width="10%">1</td>
					<td style="border-bottom:1px solid grey" width="10%">0</td>
					<td style=" border-bottom:1px solid grey" width="10%">$ 46.15</td>
					<td style="border-bottom:1px solid grey" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey" width="10%">$ 46.15</td>
				</tr>';

				$textcolors .= '<tr>
				    <td style="border-left: 1px solid grey; border-bottom:1px solid grey;" width="30%">&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Grey L</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey" width="10%">3</td>
					<td style="border-bottom:1px solid grey" width="10%">0</td>
					<td style=" border-bottom:1px solid grey" width="10%">$ 133.05</td>
					<td style="border-bottom:1px solid grey" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey" width="10%">$ 133.05</td>
				</tr>';

				$textcolors .= '<tr>
				    <td style="border-left: 1px solid grey; border-bottom:1px solid grey;" width="30%">&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;Grey S</td>
					<td style=" border-bottom:1px solid grey" width="10%"></td>
					<td style="border-bottom:1px solid grey" width="10%">2</td>
					<td style="border-bottom:1px solid grey" width="10%">0</td>
					<td style=" border-bottom:1px solid grey" width="10%">$ 91.40</td>
					<td style="border-bottom:1px solid grey" width="10%">$ 0.00</td>
					<td style="border-bottom:1px solid grey" width="10%">0.00%</td>
					<td style="border-right: 1px solid grey; border-bottom:1px solid grey" width="10%">$ 91.40</td>
				</tr>';
        	}
        }
	...
	public function pdf_summary_sale_report() {
        ...
        if($merchant_id == '543') {
        	if( ($start_date >= '2022-06-01') && ($end_date <= '2022-06-15') ) {
        		$text_Sale_html .= '<tr>
                <td style="border-left: 1px solid grey; border-bottom:1px solid grey">2022-06-09</td>
				<td style=" border-bottom:1px solid grey">353735092</td>
				<td style=" border-bottom:1px solid grey">254707608</td>
				 <td style=" border-bottom:1px solid grey">Universal Car Air Vent Phone Mount/Regular</td>
				<td style="border-bottom:1px solid grey">1</td>
				<td style=" border-bottom:1px solid grey">$ 65.60</td>
				...
				$text_Sale_html .= '<tr>
                <td style="border-left: 1px solid grey; border-bottom:1px solid grey">2022-06-09</td>
				<td style=" border-bottom:1px solid grey">353748386</td>
				<td style=" border-bottom:1px solid grey">254717810</td>
				 <td style=" border-bottom:1px solid grey">Ladies Microfleece/Black M</td>
				<td style="border-bottom:1px solid grey">1</td>
				<td style=" border-bottom:1px solid grey">$ 30.85</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 30.85</td>
                <td style="border-right: 1px solid grey; border-bottom:1px solid grey">Paid</td> 
				...
				$text_Sale_html .= '<tr>
                <td style="border-left: 1px solid grey; border-bottom:1px solid grey">2022-06-09</td>
				<td style=" border-bottom:1px solid grey">20220609145055</td>
				<td style=" border-bottom:1px solid grey">POS_20220609025055</td>
				 <td style=" border-bottom:1px solid grey">Men’s Leader Jacket/Silver 3XL</td>
				<td style="border-bottom:1px solid grey">1</td>
				<td style=" border-bottom:1px solid grey">$ 51.60</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 51.60</td>
                <td style="border-right: 1px solid grey; border-bottom:1px solid grey">Paid</td> 
				...
				$text_Sale_html .= '<tr>
                <td style="border-left: 1px solid grey; border-bottom:1px solid grey">2022-06-09</td>
				<td style=" border-bottom:1px solid grey">20220609034312</td>
				<td style=" border-bottom:1px solid grey">POS_20220609034312</td>
				 <td style=" border-bottom:1px solid grey">Bic Gel Pen/Clear Green</td>
				<td style="border-bottom:1px solid grey">1</td>
				<td style=" border-bottom:1px solid grey">$ 45.55</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 0.00</td>
				<td style="border-bottom:1px solid grey">$ 45.55</td>
                <td style="border-right: 1px solid grey; border-bottom:1px solid grey">Paid</td> 
	...
	public function inventoryreport_ExcelDownload() {
		...
		$rowCount++;
		if($merchant_id == '543') {
        	if( ($start_date >= '2022-07-01') && ($end_date <= '2022-07-30') ) {
        		
				$objPHPExcel->getActiveSheet()->SetCellValue('A' . $rowCount, 'Ladies Full Zip');
				$rowCount++;

				$objPHPExcel->getActiveSheet()->SetCellValue('A' . $rowCount, '  -Grey M');
				$objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, '');
				$objPHPExcel->getActiveSheet()->SetCellValue('C' . $rowCount, '1');
				$objPHPExcel->getActiveSheet()->SetCellValue('D' . $rowCount, '0');
				$objPHPExcel->getActiveSheet()->SetCellValue('E' . $rowCount, '$49.35');
				$objPHPExcel->getActiveSheet()->SetCellValue('F' . $rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('G' . $rowCount, '0.00%');
				$objPHPExcel->getActiveSheet()->SetCellValue('H' . $rowCount, '$49.35');
				$rowCount++;

				$objPHPExcel->getActiveSheet()->SetCellValue('A' . $rowCount, '  -Black 2XL');
				$objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, '');
				$objPHPExcel->getActiveSheet()->SetCellValue('C' . $rowCount, '1');
				$objPHPExcel->getActiveSheet()->SetCellValue('D' . $rowCount, '0');
				$objPHPExcel->getActiveSheet()->SetCellValue('E' . $rowCount, '$48.10');
				$objPHPExcel->getActiveSheet()->SetCellValue('F' . $rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('G' . $rowCount, '0.00%');
				$objPHPExcel->getActiveSheet()->SetCellValue('H' . $rowCount, '$48.10');
				$rowCount++;
		...
		if($merchant_id == '543') {
        	if( ($start_date >= '2022-07-01') && ($end_date <= '2022-07-30') ) {
        		$objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, '2022-07-21');
				$objPHPExcel->getActiveSheet()->SetCellValue('B'.$rowCount, '376429161');
				$objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, '271606708');
				$objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, 'Ladies Ashby Vest/Black XL');
				$objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, '1');
				$objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, '$49.35');
				$objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, '$49.35');
				$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount, 'Paid');
				$rowCount++;
				...
				$objPHPExcel->getActiveSheet()->SetCellValue('B'.$rowCount, '376429161');
				$objPHPExcel->getActiveSheet()->SetCellValue('C'.$rowCount, '271606708');
				$objPHPExcel->getActiveSheet()->SetCellValue('D'.$rowCount, 'Ladies Leader Jacket/Black L');
				$objPHPExcel->getActiveSheet()->SetCellValue('E'.$rowCount, '1');
				$objPHPExcel->getActiveSheet()->SetCellValue('F'.$rowCount, '$48.10');
				$objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount, '$0.00');
				$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount, '$48.10');
				$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount, 'Paid');
				$rowCount++;
