...
class SubadminCustomer extends CI_Controller
...
{ 
   ...
   if (isset($_POST['mysubmit']))

    {
      ...
      $package_data = $this->subadmin_model->get_package_details_merchant1a($start_date,$end_date);
    ...
    $package_data = $this->subadmin_model->get_package_support(""); 
    ...
    $this->load->view('subadmin/all_support', $data);
...

 {
...

    {
      ...
      $package_data = $this->subadmin_model->get_package_details_merchant2a($start_date,$end_date);
      ...
      $package_data = $this->subadmin_model->get_package_request_aa(""); 
    ...
    $this->load->view('subadmin/all_request', $data);
...

 {
...

   {
      ...
      $package_data = $this->subadmin_model->get_package_details_admin($curr_payment_date,$status);

   }

  else{

    $package_data = $this->subadmin_model->get_full_details_admin('customer_payment_request');
...
public function merchant_detail()
...

 {
  ...
  $package_data = $this->subadmin_model->get_search($start_date,$end_date,$status,'customer_payment_request');
    ...
    $package_data = $this->subadmin_model->data_get_where('customer_payment_request',array("merchant_id" => $id));



    $merchant_data = $this->subadmin_model->data_get_where_1('merchant',array("id" => $id));
   ...
   public function search_record_credntl() {
     ...
     public function search_record_column() {
       ...
       $data['item'] = $this->admin_model->data_get_where_1("order_item", array("p_id" => $searchby));
           ...
           echo $this->load->view('subadmin/show_result1', $data,true);
