   ...
   public function deleteAdvPOSMainItem_post()
{
    ...
    public function editPOSItemsNew_post_2()
{
    // Call the verification method and store the return value in the variable
    $data = array();
    $data = $this->verify_request();
  ...
  public function soledCartItem_post()
{
    ...
    if($merchant_id == $data->merchant_id)
    {
		...
		$items = $mem;
			...
			$stmt = $this->db->query("UPDATE adv_pos_cart_item SET status=2, transaction_id='".$transactionID."',tax='".$_POST['tax_status']."'  where merchant_id='".$_POST['merchant_id']."' and user_id='".$_POST['user_id']."' and status=0");
