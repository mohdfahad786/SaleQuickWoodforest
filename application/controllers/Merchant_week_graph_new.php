<?php
	...
	class Merchant_week_graph_new extends CI_Controller {
...
$date = date("Y-m-d"); 
   $getQuery1 = $this->db->query("SELECT count(id) as id from cron_limit where type ='Merchant_week_graph_new' and date_c ='" . $date . "' and merchant_id='1'  ");
...
$getQuery12 = $this->db->query("SELECT count(id) as mid from merchant where  status='active' and user_type='merchant' limit 10  ");
...
$getQuery1 = $this->db->query("SELECT id,time_zone from merchant where  status='active' and user_type='merchant' limit $start,$limit ");
