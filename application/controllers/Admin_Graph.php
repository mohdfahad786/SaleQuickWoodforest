  ...
  // 				");
	...
	public function getSalesSummaryTableData() {
		...
		if ($employee == 'all') {
			$stmt = $this->db->query("SELECT (SELECT SUM(amount) as Amount from customer_payment_request where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as Amount,
				(SELECT SUM(amount) as PAmount from pos where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as PAmount,
				(SELECT SUM(tax) as Tax from customer_payment_request where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as Tax,
				(SELECT SUM(tax) as PTax from pos where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as PTax,
				(SELECT SUM(other_charges) as c_other_charges from customer_payment_request where date_c >= '".$date_c."' and merchant_id!='413' ".$stmtQuery." and date_c <= '".$date_cc."' and (status='confirm' or status='Chargeback_Confirm')) as c_other_charges,
				(SELECT SUM(other_charges) as p_other_charges from pos where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as p_other_charges,
				(SELECT SUM(tip_amount) as tip from customer_payment_request where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as Tip,
				(SELECT SUM(tip_amount) as PTip from pos where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as PTip,
				
				(SELECT SUM(fee) as Fee from customer_payment_request where date_c >= '".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and (status='confirm' or status='Chargeback_Confirm')) as Fee,
				(SELECT SUM(fee) as PFee from pos where date_c >= '".$date_c."' and date_c <= '".$date_cc."' ".$stmtQuery." and merchant_id!='413' and (status='confirm' or status='Chargeback_Confirm')) as PFee,

				(select sum(amount) as rAmu from refund  where date_c>='".$date_c."' and date_c <= '".$date_cc."' ".$stmtQuery." and merchant_id!='413' and  status='confirm') As RAmountPOS,
  				
  				
  				(select SUM(tip_amount) as RTip from customer_payment_request  where date_r>='".$date_c."' and date_r <= '".$date_cc."' and  status='Chargeback_Confirm' and partial_refund='0' ".$stmtQuery." and merchant_id!='413') As RTip,
  				(select SUM(tip_amount) as RPTip from pos  where date_r>='".$date_c."' and date_r <= '".$date_cc."' ".$stmtQuery." and merchant_id!='413'  and status='Chargeback_Confirm' and partial_refund='0') As RPTip,
  				
  				(select SUM(tax) as RTax from customer_payment_request where date_r>='".$date_c."' and date_r <= '".$date_cc."' ".$stmtQuery." and merchant_id!='413'  and  status='Chargeback_Confirm' and partial_refund='0') As RTax,
  				(select SUM(tax) as RPTax from pos  where date_r>='".$date_c."' and date_c <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery." and status='Chargeback_Confirm' and partial_refund='0') As RPTax,
  				
  				(select SUM(other_charges) as Rc_other_charges from customer_payment_request where date_r>='".$date_c."' and date_r <= '".$date_cc."' and merchant_id!='413' ".$stmtQuery."  and  status='Chargeback_Confirm' and partial_refund='0') As Rc_other_charges,
  				(select SUM(other_charges) as Rp_other_charges from pos where date_r>='".$date_c."' and date_r <= '".$date_cc."' ".$stmtQuery." and merchant_id!='413'  and status='Chargeback_Confirm' and partial_refund='0') As Rp_other_charges,
	...
	public function getTODChartData() {
		...
		if($employee == 'all') {
			...
			(SELECT sum(amount) as Totalfeb from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery." )x group by status ) as Totalfeb   ,
			(SELECT sum(amount) as Totalmarch from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery." )x group by status ) as Totalmarch   ,
			(SELECT sum(amount) as Totalaprl from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaprl   ,
			(SELECT sum(amount) as Totalmay from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '08' and  time1 < '10' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '08' and  time1 < '10' and status='confirm' ".$stmtQuery." )x group by status ) as Totalmay   ,
			(SELECT sum(amount) as Totaljune from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '10' and  time1 < '12' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '10' and  time1 < '12' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljune   ,
			(SELECT sum(amount) as Totaljuly from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljuly   ,
			(SELECT sum(amount) as Totalaugust from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaugust   ,
			(SELECT sum(amount) as Totalsep from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery." )x group by status ) as Totalsep   ,
			(SELECT sum(amount) as Totaloct from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery." )x group by status ) as Totaloct   ,
			(SELECT sum(amount) as Totalnov from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '20' and  time1 < '22' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '20' and  time1 < '22' and status='confirm' ".$stmtQuery." )x group by status ) as Totalnov   ,
			(SELECT sum(amount) as Totaldec from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '22' and  time1 <= '24' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and time1 >= '22' and  time1 <= '24' and status='confirm' ".$stmtQuery." )x group by status ) as Totaldec   ,
			(SELECT sum(tax) as Totaljantax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and  time1 = '01' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'  and  time1 = '01' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljantax   ,
			(SELECT sum(tax) as Totalfebtax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery." )x group by status ) as Totalfebtax   ,
			(SELECT sum(tax) as Totalmarchtax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery." )x group by status ) as Totalmarchtax   ,
			(SELECT sum(tax) as Totalaprltax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaprltax   ,
			(SELECT sum(tax) as Totalmaytax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '08' and  time1 < '10' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '08' and  time1 < '10' and status='confirm' ".$stmtQuery." )x group by status ) as Totalmaytax   ,
			(SELECT sum(tax) as Totaljunetax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '10' and  time1 < '12' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '10' and  time1 < '12' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljunetax   ,
			(SELECT sum(tax) as Totaljulytax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljulytax   ,
			(SELECT sum(tax) as Totalaugusttax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaugusttax   ,
			(SELECT sum(tax) as Totalseptax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery." )x group by status ) as Totalseptax   ,
			(SELECT sum(tax) as Totalocttax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery." )x group by status ) as Totalocttax   ,
			(SELECT sum(tax) as Totalnovtax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '20' and  time1 < '22' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '20' and  time1 < '22' and status='confirm' ".$stmtQuery." )x group by status ) as Totalnovtax   ,
			(SELECT sum(tax) as Totaldectax from ( SELECT tax,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '22' and  time1 < '24' and status='confirm' ".$stmtQuery."    union all SELECT tax,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '22' and  time1 <= '24' and status='confirm' ".$stmtQuery." )x group by status ) as Totaldectax   ,
			...
			(SELECT avg(amount) as Totalfebfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '02' and  time1 < '04' and status='confirm' ".$stmtQuery." )x group by status ) as Totalfebfee   ,
			(SELECT avg(amount) as Totalmarchfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '04' and  time1 < '06' and status='confirm' ".$stmtQuery." )x group by status ) as Totalmarchfee   ,
			(SELECT avg(amount) as Totalaprlfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '06' and  time1 < '08' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaprlfee   ,
			...
			(SELECT avg(amount) as Totaljulyfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '12' and  time1 < '14' and status='confirm' ".$stmtQuery." )x group by status ) as Totaljulyfee   ,
			(SELECT avg(amount) as Totalaugustfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '14' and  time1 < '16' and status='confirm' ".$stmtQuery." )x group by status ) as Totalaugustfee   ,
			(SELECT avg(amount) as Totalsepfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '16' and  time1 < '18' and status='confirm' ".$stmtQuery." )x group by status ) as Totalsepfee   ,
			(SELECT avg(amount) as Totaloctfee from ( SELECT amount,status from customer_payment_request where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery."    union all SELECT amount,status from pos where   date_c <= '".$date_cc."' and date_c >= '".$date_c."'   and time1 >= '18' and  time1 < '20' and status='confirm' ".$stmtQuery." )x group by status ) as Totaloctfee   ,
	...
	public function trends(){
		...
		$getDashboard = $this->db->order_by('id', 'desc')->limit(1)->get('sales_trend_admin_wf');
		// $getDashboard = $this->db->query("SELECT * from admin_year_graph order by id desc limit 0,1");
	...
	public function getTrendGraph() {
		$getDashboard = $this->db->get('sales_trend_admin_wf');
		$getDashboardData = $getDashboard->result_array();
		$data['getDashboardData'] = $getDashboardData;
		// echo '<pre>';print_r($getDashboardData);die;
